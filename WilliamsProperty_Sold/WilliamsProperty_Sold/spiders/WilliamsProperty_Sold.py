...
class WilliamsProperty_Sold(scrapy.Spider):
    name = 'WilliamsProperty_Sold'
    ...
    count = 1
    db = 'WilliamsProperty'
    collection = 'WilliamsProperty_Sold'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(WilliamsProperty_Sold, self).__init__(*args, **kwargs)
        self.links = []
