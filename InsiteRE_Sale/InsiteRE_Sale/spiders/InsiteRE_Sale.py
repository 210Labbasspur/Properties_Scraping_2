...
class InsiteRE_Sale(scrapy.Spider):
    name = "InsiteRE_Sale"
    url = "https://insiterealestate.com.au/listings/?page=1&saleOrRental=Sale&rental_period=week&status=available&viewType=gallery&sortby=dateListed-desc"
    prefix = "https://insiterealestate.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(InsiteRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def parse(self, response):
        ...
        for each_url in all_links:
            each_url = f'https://insiterealestate.com.au{each_url}'
        ...
        for property_url in all_links:
            property_url = f'https://insiterealestate.com.au{property_url}'
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2592)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Insite Real Estate'
