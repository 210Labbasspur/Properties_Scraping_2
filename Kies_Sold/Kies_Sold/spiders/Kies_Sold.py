...
class Kies_Sold(scrapy.Spider):
    name = "Kies_Sold"

    url = "https://www.kies.com.au/residential-for-sale-sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(Kies_Sold, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def start_requests(self):
        ...
        yield scrapy.Request('https://www.kies.com.au/residential-for-sale-sold-2/', headers=self.headers, callback=self.parse)
        yield scrapy.Request('https://www.kies.com.au/land-for-sale-sold/', headers=self.headers, callback=self.parse)
        yield scrapy.Request('https://www.kies.com.au/land-for-sale-sold-2/', headers=self.headers, callback=self.parse)
        yield scrapy.Request('https://www.kies.com.au/rural-for-sale-sold-2/', headers=self.headers, callback=self.parse)
        yield scrapy.Request('https://www.kies.com.au/rural-for-sale-sold/', headers=self.headers, callback=self.parse)
