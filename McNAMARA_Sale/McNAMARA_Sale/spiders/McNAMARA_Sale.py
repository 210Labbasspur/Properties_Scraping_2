...
class McNAMARA_Sale(scrapy.Spider):
    name = "McNAMARA_Sale"

    url = "https://www.mcnamararealestate.com.au/search/?show_in_sale=true&sold=0&pageno={}"
    ...
    def __init__(self, *args, **kwargs):
        super(McNAMARA_Sale, self).__init__(*args, **kwargs)
        self.links = []
