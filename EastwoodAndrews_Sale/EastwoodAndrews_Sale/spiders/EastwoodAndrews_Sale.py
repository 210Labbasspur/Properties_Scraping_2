...
class EastwoodAndrews_Sale(scrapy.Spider):
    name = "EastwoodAndrews_Sale"

    url = "https://www.eastwoodandrews.com.au/buying/properties-for-sale/"
    ...
    count = 1
    db = 'EastwoodAndrews'
    collection = 'EastwoodAndrews_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(EastwoodAndrews_Sale, self).__init__(*args, **kwargs)
        self.links = []
