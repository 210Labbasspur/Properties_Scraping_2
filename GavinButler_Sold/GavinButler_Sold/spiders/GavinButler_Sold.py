...
class GavinButler_Sold(scrapy.Spider):
    name = 'GavinButler_Sold'
    url = 'https://www.gavinbutler.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=96&sort=d_sold%20desc&listing_cat0=residential&listing_cat1=commercial&listing_cat2=business&web_stage=sold'
    prefix = 'https://www.gavinbutler.com.au'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(GavinButler_Sold, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def Detail_parse(self, mini_data,full_data):
        ...
        if detail_page_url not in database_sale_matching_url:
            ...
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2565)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Gavin Butler Real Estate'
