...
class Cardamone_Sale(scrapy.Spider):
    name = "Cardamone_Sale"

    url = "https://www.cardamonerealestate.com.au/search/?show_in_sale=true&sold=0"
    ...
    def __init__(self, *args, **kwargs):
        super(Cardamone_Sale, self).__init__(*args, **kwargs)
        self.links = []
