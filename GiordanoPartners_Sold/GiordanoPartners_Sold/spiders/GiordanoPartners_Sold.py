...
class GiordanoPartners_Sold(scrapy.Spider):
    name = "GiordanoPartners_Sold"

    url = "https://giordanopartners.com/sold-properties?page=1"
    ...
    count = 1
    db = 'GiordanoPartners'
    collection = 'GiordanoPartners_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(GiordanoPartners_Sold, self).__init__(*args, **kwargs)
        self.links = []
