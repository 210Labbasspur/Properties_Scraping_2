...
class BlueMoon_Rent(scrapy.Spider):
    name = 'BlueMoon_Rent'
    url = 'https://www.bluemoonproperty.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=rental'
    ...
    def __init__(self, *args, **kwargs):
        super(BlueMoon_Rent, self).__init__(*args, **kwargs)
        self.links = []
