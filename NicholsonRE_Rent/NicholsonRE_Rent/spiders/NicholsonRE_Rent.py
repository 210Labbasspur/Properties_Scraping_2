...
class NicholsonRE_Rent(scrapy.Spider):
    name = "NicholsonRE_Rent"

    url = "https://www.nicholsonre.com.au/all-rentals/"
    ...
    def __init__(self, *args, **kwargs):
        super(NicholsonRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
