...
class DJStringer_Sold(scrapy.Spider):
    name = "DJStringer_Sold"

    url = "https://www.djstringer.com.au/sell/recently-sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(DJStringer_Sold, self).__init__(*args, **kwargs)
        self.links = []
