...
class TopRealty_Sale(scrapy.Spider):
    name = 'TopRealty_Sale'
    url = 'https://www.toprealty.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=96&sort=d_listing%20desc&listing_cat=residential'
    prefix = 'https://www.toprealty.com.au'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(TopRealty_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def Detail_parse(self, mini_data,full_data):
        ...
        if detail_page_url not in database_sale_matching_url:
            ...
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2569)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Top Realty'
