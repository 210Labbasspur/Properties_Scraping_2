...
class HunterFrench_Sold(scrapy.Spider):
    name = "HunterFrench_Sold"

    url = "https://www.hunterfrench.com.au/recently-sold/"
    prefix = "https://www.hunterfrench.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(HunterFrench_Sold, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2646)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Hunter French Real Estate'
