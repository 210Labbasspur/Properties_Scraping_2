...
class NobleKnight_Sale(scrapy.Spider):
    name = "NobleKnight_Sale"
    url = 'https://www.nobleknight.com.au/wp-admin/admin-ajax.php'
    prefix = "https://www.nobleknight.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(NobleKnight_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2623)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Noble Knight'
            ...
            item['Field8'] = ''.join(e.strip() for e in response.css(".rooms-container .carspace ::text").getall() if e.strip())
