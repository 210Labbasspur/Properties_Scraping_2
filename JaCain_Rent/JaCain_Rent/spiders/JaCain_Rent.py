...
class JaCain_Rent(scrapy.Spider):
    name = "JaCain_Rent"
    url = 'https://www.jacain.com.au/wp-admin/admin-ajax.php'
    prefix = "https://www.jacain.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(JaCain_Rent, self).__init__(*args, **kwargs)
        self.links = []
