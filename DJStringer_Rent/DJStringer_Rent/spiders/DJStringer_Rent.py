...
class DJStringer_Rent(scrapy.Spider):
    name = "DJStringer_Rent"

    url = "https://www.djstringer.com.au/rent/residential/"
    ...
    def __init__(self, *args, **kwargs):
        super(DJStringer_Rent, self).__init__(*args, **kwargs)
        self.links = []
