...
class KeithWilliams_Sold(scrapy.Spider):
    name = "KeithWilliams_Sold"
    ...
    count = 1
    db = 'KeithWilliams'
    collection = 'KeithWilliams_Sold'
    bucket_prefix = f'Images6'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(KeithWilliams_Sold, self).__init__(*args, **kwargs)
        self.links = []
