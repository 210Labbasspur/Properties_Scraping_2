...
class HaymanPartners_Sale(scrapy.Spider):
    name = "HaymanPartners_Sale"

    url = "https://haymanpartners.com.au/buy/"
    ...
    count = 1
    db = 'HaymanPartners'
    collection = 'HaymanPartners_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(HaymanPartners_Sale, self).__init__(*args, **kwargs)
        self.links = []
