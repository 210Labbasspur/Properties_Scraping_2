...
class BasePG_Sold(scrapy.Spider):
    name = "BasePG_Sold"
    url = "https://basepropertygroup.com.au/listings/?saleOrRental=Sale&status=sold&sortby=saleDate-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(BasePG_Sold, self).__init__(*args, **kwargs)
        self.links = []
