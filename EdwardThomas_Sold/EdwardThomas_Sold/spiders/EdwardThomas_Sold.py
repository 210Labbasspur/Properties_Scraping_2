...
class EdwardThomas_Sold(scrapy.Spider):
    name = "EdwardThomas_Sold"
    url = "https://edwardthomas.com.au/listings?page=1&saleOrRental=Sale&rental_period=week&status=sold&viewType=gallery&sortby=dateListed"
    ...
    def __init__(self, *args, **kwargs):
        super(EdwardThomas_Sold, self).__init__(*args, **kwargs)
        self.links = []
