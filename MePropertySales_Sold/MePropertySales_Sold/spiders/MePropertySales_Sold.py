...
class MePropertySales_Sold(scrapy.Spider):
    name = "MePropertySales_Sold"
    url = "https://mepropertysales.com.au/listings?page=1&saleOrRental=Sale&rental_period=week&status=sold&viewType=gallery"
    ...
    count = 1
    db = 'MePropertySales'
    collection = 'MePropertySales_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(MePropertySales_Sold, self).__init__(*args, **kwargs)
        self.links = []
