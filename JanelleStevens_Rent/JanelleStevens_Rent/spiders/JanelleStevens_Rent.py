...
class JanelleStevens_Rent(scrapy.Spider):
    name = "JanelleStevens_Rent"
    ...
    count = 1
    db = 'JanelleStevens'
    collection = 'JanelleStevens_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(JanelleStevens_Rent, self).__init__(*args, **kwargs)
        self.links = []
