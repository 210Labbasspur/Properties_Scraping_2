...
class AltairProperty_Sale(scrapy.Spider):
    name = "AltairProperty_Sale"
    url = 'https://www.altairproperty.com.au/wp-admin/admin-ajax.php'
    prefix = "https://www.altairproperty.com"
    headers = {
    ...
    count = 1
    db = 'AltairProperty'
    collection = 'AltairProperty_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(AltairProperty_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2391)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Altair Property'
