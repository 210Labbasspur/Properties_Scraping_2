...
class NicholsonRE_Sale(scrapy.Spider):
    name = "NicholsonRE_Sale"

    url = "https://www.nicholsonre.com.au/all-properties/"
    ...
    def __init__(self, *args, **kwargs):
        super(NicholsonRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
