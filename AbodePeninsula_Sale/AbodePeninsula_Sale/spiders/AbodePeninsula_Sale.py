...
class AbodePeninsula_Sale(scrapy.Spider):
    name = "AbodePeninsula_Sale"

    url = "https://www.abodepeninsula.com.au/properties-for-sale"
    ...
    count = 1
    db = 'AbodePeninsula'
    collection = 'AbodePeninsula_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(AbodePeninsula_Sale, self).__init__(*args, **kwargs)
        self.links = []
