...
class FlynnandCo_Sale(scrapy.Spider):
    name = "FlynnandCo_Sale"
    url = "https://flynnandco.com.au/listings?saleOrRental=Sale&status=available_under_contract&sortby=dateListed-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(FlynnandCo_Sale, self).__init__(*args, **kwargs)
        self.links = []
