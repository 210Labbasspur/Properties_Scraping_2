...
class Shepparton_Rent(scrapy.Spider):
    name = "Shepparton_Rent"

    url = "https://www.sheppartonrealestate.com.au/for-rent/"
    prefix = "https://www.sheppartonrealestate.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(Shepparton_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2640)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Shepparton Real Estate'
            ...
            item['Field6'] = response.xpath("//*[contains(@title,'Beds')]/*[2]/text()").get('').strip()
            item['Field7'] = response.xpath("//*[contains(@title,'Baths')]/*[2]/text()").get('').strip()
            item['Field8'] = response.xpath("//*[contains(@title,'Cars')]/*[2]/text()").get('').strip()
