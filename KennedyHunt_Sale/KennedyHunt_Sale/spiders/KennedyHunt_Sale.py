...
class KennedyHunt_Sale(scrapy.Spider):
    name = "KennedyHunt_Sale"

    url = "https://www.kennedyandhunt.com.au/buying/properties-for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(KennedyHunt_Sale, self).__init__(*args, **kwargs)
        self.links = []
