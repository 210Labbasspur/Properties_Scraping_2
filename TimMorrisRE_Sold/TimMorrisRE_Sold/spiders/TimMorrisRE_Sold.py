...
class TimMorrisRE_Sold(scrapy.Spider):
    name = 'TimMorrisRE_Sold'
    url = "https://www.timmorris.com.au/sell/recent-sales/"
    ...
    count = 1
    db = 'TimMorrisRE'
    collection = 'TimMorrisRE_Sold'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(TimMorrisRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
