...
class AllanRE_Rent(scrapy.Spider):
    name = "AllanRE_Rent"
    url = "https://allanre.com.au/listings/?saleOrRental=Rental&type=Residential&order=dateListed-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(AllanRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
