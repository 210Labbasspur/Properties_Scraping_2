...
class TheCoastRE_Sale(scrapy.Spider):
    name = "TheCoastRE_Sale"
    url = "https://thecoast.com.au/listings?saleOrRental=Sale&status=available_under_contract&sortby=post_date-desc/"
    ...
    def __init__(self, *args, **kwargs):
        super(TheCoastRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
