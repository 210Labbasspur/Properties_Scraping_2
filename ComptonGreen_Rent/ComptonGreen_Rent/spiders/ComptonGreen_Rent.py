...
class ComptonGreen_Rent(scrapy.Spider):
    name = "ComptonGreen_Rent"

    url = "https://www.comptongreen.com.au/rent"
    ...
    def __init__(self, *args, **kwargs):
        super(ComptonGreen_Rent, self).__init__(*args, **kwargs)
        self.links = []
