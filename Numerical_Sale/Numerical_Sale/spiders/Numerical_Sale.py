...
class Numerical_Sale(scrapy.Spider):
    name = "Numerical_Sale"
    url = "https://numericalrealestate.com/listings?saleOrRental=Sale&status=available_under_contract&sortby=dateListed-desc&type=Residential"
    prefix = "https://numericalrealestate.com"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(Numerical_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def start_requests(self):
        ...
        yield scrapy.Request('https://numericalrealestate.com/listings?saleOrRental=Sale&status=available_under_contract&sortby=dateListed-desc&type=Land',
    ...
    def parse(self, response):
        ...
        for each_url in all_links:
            each_url = f'https://numericalrealestate.com{each_url}'
        ...
        for property_url in all_links:
            property_url = f'https://numericalrealestate.com{property_url}'
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2457)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Numerical Real Estate'
            ...
            prop_images = [url.replace('\\', '') for url in full_image_urls]
            images = []
