...
class PaganRE_Sale(scrapy.Spider):
    name = "PaganRE_Sale"

    url = "https://www.paganrealestate.com.au/data/results/?listing_category=residential&listing_sale_method=Sale&pg={}"
    ...
    def __init__(self, *args, **kwargs):
        super(PaganRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
