...
class ScarceRE_Rent(scrapy.Spider):
    name = 'ScarceRE_Rent'
    prefix = 'https://www.scarce.com.au'
    url = 'https://www.scarce.com.au/propertiesJson?callback=angular.callbacks._0&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=rental'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(ScarceRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
