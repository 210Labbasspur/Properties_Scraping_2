...
class NickJohnStone_Sale(scrapy.Spider):
    name = 'NickJohnStone_Sale'
    url = "https://www.nickjohnstone.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=residential"
    ...
    count = 1
    db = 'NickJohnStone'
    collection = 'NickJohnStone_Sale'
    bucket_prefix = f'D_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(NickJohnStone_Sale, self).__init__(*args, **kwargs)
        self.links = []
