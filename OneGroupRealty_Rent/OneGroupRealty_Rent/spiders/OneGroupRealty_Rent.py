...
class OneGroupRealty_Rent(scrapy.Spider):
    name = "OneGroupRealty_Rent"

    url = "https://www.onegrouprealty.com.au/properties/rental"
    ...
    count = 1
    db = 'OneGroupRealty'
    collection = 'OneGroupRealty_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(OneGroupRealty_Rent, self).__init__(*args, **kwargs)
        self.links = []
