###############3            AreaSpecialistWyndhamCity_Rent
...
class AreaSpecialistWyndhamCity_Rent(scrapy.Spider):
    name = "AreaSpecialistWyndhamCity_Rent"

    url = "https://wyndhamcity.areaspecialist.com.au/data/results/?listing_sale_method=Lease&gallery=1&pg={}"
    ...
    collection = 'AreaSpecialistWyndhamCity_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(AreaSpecialistWyndhamCity_Rent, self).__init__(*args, **kwargs)
        self.links = []
