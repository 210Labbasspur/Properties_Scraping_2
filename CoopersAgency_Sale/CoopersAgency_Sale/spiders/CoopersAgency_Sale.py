...
class CoopersAgency_Sale(scrapy.Spider):
    name = "CoopersAgency_Sale"

    url = "https://coopers.agency/properties-for-sale"
    ...
    def __init__(self, *args, **kwargs):
        super(CoopersAgency_Sale, self).__init__(*args, **kwargs)
        self.links = []
