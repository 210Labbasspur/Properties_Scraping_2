...
class KeatingEstates_Sale(scrapy.Spider):
    name = "KeatingEstates_Sale"

    url = "https://www.keatingestates.com/sales"
    ...
    count = 1
    db = 'KeatingEstates'
    collection = 'KeatingEstates_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(KeatingEstates_Sale, self).__init__(*args, **kwargs)
        self.links = []
