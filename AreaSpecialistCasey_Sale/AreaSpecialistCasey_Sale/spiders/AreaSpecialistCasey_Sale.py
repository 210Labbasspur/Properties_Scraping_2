...
class AreaSpecialistCasey_Sale(scrapy.Spider):
    name = "AreaSpecialistCasey_Sale"

    url = "https://www.areaspecialistcasey.com.au/pages/real-estate/results?widgetKey=122479&context=listings&returnAs=markup&listing_sale_method=Sale&display_sale_method=BUY&pg=1"
    ...
    collection = 'AreaSpecialistCasey_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(AreaSpecialistCasey_Sale, self).__init__(*args, **kwargs)
        self.links = []
