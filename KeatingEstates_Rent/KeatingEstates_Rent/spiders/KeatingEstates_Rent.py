...
class KeatingEstates_Rent(scrapy.Spider):
    name = "KeatingEstates_Rent"

    url = "https://www.keatingestates.com/lettings"
    ...
    count = 1
    db = 'KeatingEstates'
    collection = 'KeatingEstates_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(KeatingEstates_Rent, self).__init__(*args, **kwargs)
        self.links = []
