...
class BillWyndham_Rent(scrapy.Spider):
    name = "BillWyndham_Rent"

    url = "https://www.billwyndham.com.au/listings/rent"
    ...
    def __init__(self, *args, **kwargs):
        super(BillWyndham_Rent, self).__init__(*args, **kwargs)
        self.links = []
