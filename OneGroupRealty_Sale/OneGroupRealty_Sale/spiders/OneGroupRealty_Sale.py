...
class OneGroupRealty_Sale(scrapy.Spider):
    name = "OneGroupRealty_Sale"

    url = "https://www.onegrouprealty.com.au/properties/sale"
    ...
    count = 1
    db = 'OneGroupRealty'
    collection = 'OneGroupRealty_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(OneGroupRealty_Sale, self).__init__(*args, **kwargs)
        self.links = []
