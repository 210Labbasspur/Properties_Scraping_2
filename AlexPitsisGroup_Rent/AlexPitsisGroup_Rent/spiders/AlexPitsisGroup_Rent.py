...
class AlexPitsisGroup_Rent(scrapy.Spider):
    name = "AlexPitsisGroup_Rent"

    url = "https://alexpitsisgroup.com.au/for-rent/?paged={}"
    ...
    count = 1
    db = 'AlexPitsisGroup'
    collection = 'AlexPitsisGroup_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(AlexPitsisGroup_Rent, self).__init__(*args, **kwargs)
        self.links = []
