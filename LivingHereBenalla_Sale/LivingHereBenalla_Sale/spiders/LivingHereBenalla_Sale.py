...
class LivingHereBenalla_Sale(scrapy.Spider):
    name = "LivingHereBenalla_Sale"
    url = 'https://livingherebenalla.com.au/wp-admin/admin-ajax.php'
    prefix = "https://livingherebenalla.com.au"
    headers = {
    'accept': '*/*',
    'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
    'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
    'origin': 'https://livingherebenalla.com.au',
    'priority': 'u=1, i',
    'referer': 'https://livingherebenalla.com.au/buy-me/properties-sold/',
    ...
    # 'cookie': '_ga=GA1.3.1223189141.1746422157; _gid=GA1.3.136891437.1746983246; _gat=1; _ga_TGJ1HZVDZZ=GS2.3.s1746983249$o2$g0$t1746983249$j0$l0$h0',
}
    data = {
    'atts[list]': 'sale',
    'atts[multilist]': '',
    ...
    count = 1
    db = 'LivingHereBenalla'
    collection = 'LivingHereBenalla_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(LivingHereBenalla_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2677)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Living Here Benalla Real Estate'
