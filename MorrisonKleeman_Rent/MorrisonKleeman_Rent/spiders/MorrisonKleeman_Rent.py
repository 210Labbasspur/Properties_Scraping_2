...
class MorrisonKleeman_Rent(scrapy.Spider):
    name = "MorrisonKleeman_Rent"

    url = "https://www.morrisonkleeman.com.au/search-list?type=Rent"
    ...
    count = 1
    db = 'MorrisonKleeman'
    collection = 'MorrisonKleeman_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(MorrisonKleeman_Rent, self).__init__(*args, **kwargs)
        self.links = []
