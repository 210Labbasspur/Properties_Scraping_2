...
class FrankGordon_Rent(scrapy.Spider):
    name = "FrankGordon_Rent"

    url = "https://www.frankgordon.com.au/for-rent/"
    ...
    def __init__(self, *args, **kwargs):
        super(FrankGordon_Rent, self).__init__(*args, **kwargs)
        self.links = []
