...
class KeepingItRealty_Sale(scrapy.Spider):
    name = "KeepingItRealty_Sale"

    url = "https://www.keepingitrealty.com.au/properties-for-sale/"
    ...
    count = 1
    db = 'KeepingItRealty'
    collection = 'KeepingItRealty_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(KeepingItRealty_Sale, self).__init__(*args, **kwargs)
        self.links = []
