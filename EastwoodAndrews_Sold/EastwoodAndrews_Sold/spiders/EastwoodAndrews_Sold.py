...
class EastwoodAndrews_Sold(scrapy.Spider):
    name = "EastwoodAndrews_Sold"

    url = "https://www.eastwoodandrews.com.au/selling/recent-sales/"
    ...
    count = 1
    db = 'EastwoodAndrews'
    collection = 'EastwoodAndrews_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(EastwoodAndrews_Sold, self).__init__(*args, **kwargs)
        self.links = []
