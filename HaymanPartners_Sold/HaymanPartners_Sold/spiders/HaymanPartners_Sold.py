...
class HaymanPartners_Sold(scrapy.Spider):
    name = "HaymanPartners_Sold"

    url = "https://haymanpartners.com.au/buy/?property-type=sold"
    ...
    count = 1
    db = 'HaymanPartners'
    collection = 'HaymanPartners_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(HaymanPartners_Sold, self).__init__(*args, **kwargs)
        self.links = []
