...
class TrevorPetrie_Sold(scrapy.Spider):
    name = "TrevorPetrie_Sold"

    url = "https://www.trevorpetrie.com.au/sell/sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(TrevorPetrie_Sold, self).__init__(*args, **kwargs)
        self.links = []
