...
class NorthWestRE_Rent(scrapy.Spider):
    name = "NorthWestRE_Rent"

    url = "https://www.northwestrealestate.net.au/rent"
    ...
    def __init__(self, *args, **kwargs):
        super(NorthWestRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
