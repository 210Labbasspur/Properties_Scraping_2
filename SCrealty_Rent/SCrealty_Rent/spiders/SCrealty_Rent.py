...
class SCrealty_Rent(scrapy.Spider):
    name = 'SCrealty_Rent'
    url = "https://www.screalty.com.au/renting/properties-for-lease/"
    ...
    count = 1
    db = 'SCrealty'
    collection = 'SCrealty_Rent'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(SCrealty_Rent, self).__init__(*args, **kwargs)
        self.links = []
