...
class StrzeleckiRealty_Sold(scrapy.Spider):
    name = 'StrzeleckiRealty_Sold'
    url = 'https://www.strzeleckirealty.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=96&sort=d_sold%20desc&web_stage=sold'
    ...
    count = 1
    db = 'StrzeleckiRealty'
    collection = 'StrzeleckiRealty_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(StrzeleckiRealty_Sold, self).__init__(*args, **kwargs)
        self.links = []
