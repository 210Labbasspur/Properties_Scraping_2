...
class IntegrityRE_Rent(scrapy.Spider):
    name = 'IntegrityRE_Rent'
    prefix = 'https://www.integrityrealestate.com.au'
    url = 'https://www.integrityrealestate.com.au/propertiesJson?callback=angular.callbacks._0&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat0=rental'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(IntegrityRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
