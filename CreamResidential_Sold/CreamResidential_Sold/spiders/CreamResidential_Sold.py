...
class CreamResidential_Sold(scrapy.Spider):
    name = "CreamResidential_Sold"

    url = "https://creamresidential.com.au/sold"
    ...
    count = 1
    db = 'CreamResidential'
    collection = 'CreamResidential_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(CreamResidential_Sold, self).__init__(*args, **kwargs)
        self.links = []
