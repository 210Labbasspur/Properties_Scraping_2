...
class HomeByHolly_Rent(scrapy.Spider):
    name = "HomeByHolly_Rent"

    url = "https://homebyholly.com.au/for-rent/"
    ...
    def __init__(self, *args, **kwargs):
        super(HomeByHolly_Rent, self).__init__(*args, **kwargs)
        self.links = []
