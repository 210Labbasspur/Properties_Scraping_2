...
class EdwardThomas_Rent(scrapy.Spider):
    name = "EdwardThomas_Rent"
    url = "https://edwardthomas.com.au/listings?status=available&saleOrRental=Rental&sortby=dateListed-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(EdwardThomas_Rent, self).__init__(*args, **kwargs)
        self.links = []
