...
class AllanRE_Sold(scrapy.Spider):
    name = "AllanRE_Sold"
    url = "https://allanre.com.au/listings/?saleOrRental=Sale&sold=1"
    ...
    def __init__(self, *args, **kwargs):
        super(AllanRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
