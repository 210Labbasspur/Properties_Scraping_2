...
class RykersRE_Sale(scrapy.Spider):
    name = "RykersRE_Sale"
    url = 'https://rykersrealestate.com.au/listings/?saleOrRental=Sale&type=Residential&order=dateListed-desc'
    prefix = "https://rykersrealestate.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(RykersRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def parse(self, response):
        '''    FARHAN'S LOGIC    '''
        all_links = response.xpath("//*[contains(@class,'v2-w-full v2-bg-light-grey')]/a/@href").getall()
        links = []
        for each_url in all_links:
            each_url = f'https://rykersrealestate.com.au{each_url}'
        ...
        for property_url in all_links:
            property_url = f'https://rykersrealestate.com.au{property_url}'
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2671)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Rykers Real Estate'
