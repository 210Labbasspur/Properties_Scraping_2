...
class TimMorrisRE_Leased(scrapy.Spider):
    name = 'TimMorrisRE_Leased'
    url = "https://www.timmorris.com.au/rent/leased-properties/"
    prefix = 'https://www.timmorris.com.au'
    headers = {
    ...
    count = 1
    db = 'TimMorrisRE'
    collection = 'TimMorrisRE_Leased'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(TimMorrisRE_Leased, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2475)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Tim Morris Real Estate'
