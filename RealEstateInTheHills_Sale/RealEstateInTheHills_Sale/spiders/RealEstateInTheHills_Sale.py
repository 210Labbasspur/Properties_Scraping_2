...
class RealEstateInTheHills_Sale(scrapy.Spider):
    name = "RealEstateInTheHills_Sale"

    url = "https://realestateinthehills.com/for-sale/"
    ...
    collection = 'RealEstateInTheHills_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(RealEstateInTheHills_Sale, self).__init__(*args, **kwargs)
        self.links = []
