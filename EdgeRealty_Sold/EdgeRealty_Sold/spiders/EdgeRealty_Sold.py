...
class EdgeRealty_Sold(scrapy.Spider):
    name = "EdgeRealty_Sold"

    url = "https://www.edgerealty.com.au/selling/recent-sales/"
    ...
    def __init__(self, *args, **kwargs):
        super(EdgeRealty_Sold, self).__init__(*args, **kwargs)
        self.links = []
