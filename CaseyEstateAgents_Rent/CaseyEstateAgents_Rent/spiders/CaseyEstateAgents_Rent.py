...
class CaseyEstateAgents_Rent(scrapy.Spider):
    name = "CaseyEstateAgents_Rent"

    url = "https://www.caseyestateagents.melbourne/pages/real-estate/results?widgetKey=283015&context=listings&returnAs=markup&listing_sale_method=lease&display_sale_method=Rent&pg=1"
    ...
    collection = 'CaseyEstateAgents_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(CaseyEstateAgents_Rent, self).__init__(*args, **kwargs)
        self.links = []
