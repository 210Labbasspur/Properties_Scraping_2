...
class SmithPartners_Rent(scrapy.Spider):
    name = "SmithPartners_Rent"
    url = "https://smithpartnersrealestate.com.au/listings?saleOrRental=Rental&status=available&sortby=dateListed-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(SmithPartners_Rent, self).__init__(*args, **kwargs)
        self.links = []
