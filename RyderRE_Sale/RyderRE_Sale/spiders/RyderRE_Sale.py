...
class RyderRE_Sale(scrapy.Spider):
    name = "RyderRE_Sale"

    url = "https://www.ryderrealestate.com.au/search/?show_in_sale=true&sold=0&order_by=listing_date&order=desc"
    ...
    def __init__(self, *args, **kwargs):
        super(RyderRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
