...
class UrbanWARE_Rent(scrapy.Spider):
    name = 'UrbanWARE_Rent'
    prefix = 'https://www.urbanwa.com.au'
    url = "https://www.urbanwa.com.au/propertiesJson?callback=angular.callbacks._0&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=rental"
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(UrbanWARE_Rent, self).__init__(*args, **kwargs)
        self.links = []
