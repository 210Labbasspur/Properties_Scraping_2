...
class TrevorPetrie_Sale(scrapy.Spider):
    name = "TrevorPetrie_Sale"

    url = "https://www.trevorpetrie.com.au/buy/"
    ...
    def __init__(self, *args, **kwargs):
        super(TrevorPetrie_Sale, self).__init__(*args, **kwargs)
        self.links = []
