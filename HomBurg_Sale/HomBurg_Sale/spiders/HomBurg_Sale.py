...
class HomBurg_Sale(scrapy.Spider):
    name = "HomBurg_Sale"

    url = "https://homburg.com.au/ajax-search-listings?page=1&property_type%5B%5D=Residential&property_type%5B%5D=Residential+Land&type=Buy"
    ...
    def __init__(self, *args, **kwargs):
        super(HomBurg_Sale, self).__init__(*args, **kwargs)
        self.links = []
