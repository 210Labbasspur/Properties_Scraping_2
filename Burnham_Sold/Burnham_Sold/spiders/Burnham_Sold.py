...
class Burnham_Sold(scrapy.Spider):
    name = "Burnham_Sold"
    url = "https://burnham.com.au/listings/?saleOrRental=Sale&status=sold&sortby=saleDate-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(Burnham_Sold, self).__init__(*args, **kwargs)
        self.links = []
