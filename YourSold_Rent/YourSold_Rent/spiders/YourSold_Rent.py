...
class YourSold_Rent(scrapy.Spider):
    name = 'YourSold_Rent'
    url = 'https://www.yoursoldrealestate.com.au/propertiesJson?callback=angular.callbacks._0&currentPage={}&perPage=96&sort=d_listing%20desc&listing_cat=rental'
    # url = 'https://www.yoursoldrealestate.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=96&sort=d_listing%20desc&listing_cat=residential'
    prefix = 'https://www.yoursoldrealestate.com.au'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(YourSold_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def Detail_parse(self, mini_data,full_data):
        ...
        if detail_page_url not in database_sale_matching_url:
            ...
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2695)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Your Sold Real Estate'
