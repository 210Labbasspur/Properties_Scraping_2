...
class Shepparton_Sale(scrapy.Spider):
    name = "Shepparton_Sale"

    url = "https://www.sheppartonrealestate.com.au/for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(Shepparton_Sale, self).__init__(*args, **kwargs)
        self.links = []
