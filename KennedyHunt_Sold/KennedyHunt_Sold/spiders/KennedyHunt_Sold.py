...
class KennedyHunt_Sold(scrapy.Spider):
    name = "KennedyHunt_Sold"

    url = "https://www.kennedyandhunt.com.au/selling/recent-sales/"
    ...
    def __init__(self, *args, **kwargs):
        super(KennedyHunt_Sold, self).__init__(*args, **kwargs)
        self.links = []
