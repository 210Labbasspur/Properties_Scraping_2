...
class AlexPitsisGroup_Sale(scrapy.Spider):
    name = "AlexPitsisGroup_Sale"

    url = "https://alexpitsisgroup.com.au/for-sale/?paged={}"
    ...
    count = 1
    db = 'AlexPitsisGroup'
    collection = 'AlexPitsisGroup_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(AlexPitsisGroup_Sale, self).__init__(*args, **kwargs)
        self.links = []
