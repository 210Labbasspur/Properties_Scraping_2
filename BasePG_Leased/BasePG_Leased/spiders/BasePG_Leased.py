...
class BasePG_Leased(scrapy.Spider):
    name = "BasePG_Leased"
    url = "https://basepropertygroup.com.au/listings/?saleOrRental=Rental&status=sold&sortby=saleDate-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(BasePG_Leased, self).__init__(*args, **kwargs)
        self.links = []
