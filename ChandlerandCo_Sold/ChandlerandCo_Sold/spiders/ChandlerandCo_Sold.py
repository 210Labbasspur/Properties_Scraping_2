...
class ChandlerandCo_Sold(scrapy.Spider):
    name = "ChandlerandCo_Sold"

    url = "https://chandlerandco.com.au/sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(ChandlerandCo_Sold, self).__init__(*args, **kwargs)
        self.links = []
