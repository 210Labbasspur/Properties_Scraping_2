...
class RykersRE_Sold(scrapy.Spider):
    name = "RykersRE_Sold"
    url = 'https://rykersrealestate.com.au/listings?agent=Chris%20Rykers&sold=1&saleOrRental=Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(RykersRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
