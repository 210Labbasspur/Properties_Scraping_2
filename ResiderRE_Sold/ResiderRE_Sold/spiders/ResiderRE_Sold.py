...
class ResiderRE_Sold(scrapy.Spider):
    name = "ResiderRE_Sold"

    url = "https://www.residerre.com.au/sell/recent-sales/"
    ...
    def __init__(self, *args, **kwargs):
        super(ResiderRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
