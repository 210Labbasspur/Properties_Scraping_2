...
class ThePropertyCoSA_Rent(scrapy.Spider):
    name = "ThePropertyCoSA_Rent"
    ...
    count = 1
    db = 'ThePropertyCoSA'
    collection = 'ThePropertyCoSA_Rent'
    bucket_prefix = f'Images6'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(ThePropertyCoSA_Rent, self).__init__(*args, **kwargs)
        self.links = []
