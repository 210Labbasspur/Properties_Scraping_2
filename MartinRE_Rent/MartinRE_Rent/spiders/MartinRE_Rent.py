...
class MartinRE_Rent(scrapy.Spider):
    name = 'MartinRE_Rent'
    url = "https://www.martinrealestate.com.au/renting/properties-for-lease/"
    prefix = 'https://www.martinrealestate.com.au'
    headers = {
    ...
    count = 1
    db = 'MartinRE'
    collection = 'MartinRE_Rent'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(MartinRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            ...
            prop_images = response.xpath("//*[contains(@class,'img-orientation img-orientation-landscape img-default-used-size-hd')]/@src").getall()
            images = []
