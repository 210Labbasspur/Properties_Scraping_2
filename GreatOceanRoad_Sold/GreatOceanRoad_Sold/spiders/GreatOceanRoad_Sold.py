...
class GreatOceanRoad_Sold(scrapy.Spider):
    name = "GreatOceanRoad_Sold"

    url = "https://www.greatoceanroadrealestate.com.au/selling/"
    ...
    count = 1
    db = 'GreatOceanRoad'
    collection = 'GreatOceanRoad_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(GreatOceanRoad_Sold, self).__init__(*args, **kwargs)
        self.links = []
