...
class GreatOceanRoad_Sale(scrapy.Spider):
    name = "GreatOceanRoad_Sale"

    url = "https://www.greatoceanroadrealestate.com.au/buying/"
    ...
    count = 1
    db = 'GreatOceanRoad'
    collection = 'GreatOceanRoad_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(GreatOceanRoad_Sale, self).__init__(*args, **kwargs)
        self.links = []
