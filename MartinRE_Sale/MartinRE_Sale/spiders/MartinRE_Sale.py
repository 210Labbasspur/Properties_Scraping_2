...
class MartinRE_Sale(scrapy.Spider):
    name = 'MartinRE_Sale'
    url = "https://www.martinrealestate.com.au/buying/properties-for-sale/"
    ...
    count = 1
    db = 'MartinRE'
    collection = 'MartinRE_Sale'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(MartinRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
