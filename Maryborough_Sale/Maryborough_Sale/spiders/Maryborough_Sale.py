...
class Maryborough_Sale(scrapy.Spider):
    name = "Maryborough_Sale"

    url = "https://www.maryboroughballaratrealestate.com.au/buy/property-search/"
    ...
    def __init__(self, *args, **kwargs):
        super(Maryborough_Sale, self).__init__(*args, **kwargs)
        self.links = []
