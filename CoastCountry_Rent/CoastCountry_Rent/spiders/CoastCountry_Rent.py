...
class CoastCountry_Rent(scrapy.Spider):
    name = "CoastCountry_Rent"

    url = "https://www.coastandcountryfn.com.au/rent/properties-for-lease/"
    ...
    def __init__(self, *args, **kwargs):
        super(CoastCountry_Rent, self).__init__(*args, **kwargs)
        self.links = []
