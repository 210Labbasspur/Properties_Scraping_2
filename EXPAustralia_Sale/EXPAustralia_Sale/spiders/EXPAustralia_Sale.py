...
class EXPAustralia_Sale(scrapy.Spider):
    name = "EXPAustralia_Sale"

    url = "https://www.expaustralia.com.au/buying/for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(EXPAustralia_Sale, self).__init__(*args, **kwargs)
        self.links = []
