...
class JanelleStevens_Sold(scrapy.Spider):
    name = "JanelleStevens_Sold"
    ...
    count = 1
    db = 'JanelleStevens'
    collection = 'JanelleStevens_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(JanelleStevens_Sold, self).__init__(*args, **kwargs)
        self.links = []
