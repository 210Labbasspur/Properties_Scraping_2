...
class ChangingPlaces_Sold(scrapy.Spider):
    name = "ChangingPlaces_Sold"

    url = "https://changingplaces.com.au/sell/recent-sales/"
    ...
    count = 1
    db = 'ChangingPlaces'
    collection = 'ChangingPlaces_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(ChangingPlaces_Sold, self).__init__(*args, **kwargs)
        self.links = []
