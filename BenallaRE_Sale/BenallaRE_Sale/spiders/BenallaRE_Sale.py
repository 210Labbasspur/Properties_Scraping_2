...
class BenallaRE_Sale(scrapy.Spider):
    name = 'BenallaRE_Sale'
    prefix = 'https://www.benallarealestate.net.au'
    url = 'https://www.benallarealestate.net.au/propertiesJson?callback=angular.callbacks._0&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=residential'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(BenallaRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def Detail_parse(self, mini_data,full_data):
        ...
        if detail_page_url not in database_sale_matching_url:
            ...
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2794)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Benalla Residential Rural Real Estate'
