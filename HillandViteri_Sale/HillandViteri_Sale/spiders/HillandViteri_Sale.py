...
class HillandViteri_Sale(scrapy.Spider):
    name = "HillandViteri_Sale"
    ...
    def __init__(self, *args, **kwargs):
        super(HillandViteri_Sale, self).__init__(*args, **kwargs)
        self.links = []
