...
class WalterIrvine_Sold(scrapy.Spider):
    name = "WalterIrvine_Sold"

    url = "https://walterirvine.com.au/sold/?page=1"
    ...
    def __init__(self, *args, **kwargs):
        super(WalterIrvine_Sold, self).__init__(*args, **kwargs)
        self.links = []
