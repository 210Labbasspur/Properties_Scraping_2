...
class Doepels_Sale(scrapy.Spider):
    name = "Doepels_Sale"

    url = "https://www.doepels.com.au/buying/properties-for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(Doepels_Sale, self).__init__(*args, **kwargs)
        self.links = []
