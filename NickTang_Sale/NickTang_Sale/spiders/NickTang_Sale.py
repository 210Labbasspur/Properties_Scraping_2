...
class NickTang_Sale(scrapy.Spider):
    name = "NickTang_Sale"

    url = "https://www.nicktangproperty.com.au/properties/sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(NickTang_Sale, self).__init__(*args, **kwargs)
        self.links = []
