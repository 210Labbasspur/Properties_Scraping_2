...
class Maryborough_Rent(scrapy.Spider):
    name = "Maryborough_Rent"

    url = "https://www.maryboroughballaratrealestate.com.au/rent/for-lease/"
    ...
    def __init__(self, *args, **kwargs):
        super(Maryborough_Rent, self).__init__(*args, **kwargs)
        self.links = []
