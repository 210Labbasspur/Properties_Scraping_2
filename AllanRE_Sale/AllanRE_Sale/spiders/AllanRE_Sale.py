...
class AllanRE_Sale(scrapy.Spider):
    name = "AllanRE_Sale"
    url = "https://allanre.com.au/listings?saleOrRental=Sale&status=available_under_contract&sortby=dateListed-desc"
    prefix = "https://allanre.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(AllanRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def parse(self, response):
        ...
        for each_url in all_links:
            each_url = f'https://allanre.com.au{each_url}'
        ...
        for property_url in all_links:
            property_url = f'https://allanre.com.au{property_url}'
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2390)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Allan Real Estate'
