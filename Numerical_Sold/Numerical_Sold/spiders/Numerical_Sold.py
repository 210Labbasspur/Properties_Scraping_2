...
class Numerical_Sold(scrapy.Spider):
    name = "Numerical_Sold"
    url = "https://numericalrealestate.com/listings/?saleOrRental=Sale&status=sold&sortby=saleDate-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(Numerical_Sold, self).__init__(*args, **kwargs)
        self.links = []
