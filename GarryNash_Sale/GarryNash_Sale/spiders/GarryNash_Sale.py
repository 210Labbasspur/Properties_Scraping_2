...
class GarryNash_Sale(scrapy.Spider):
    name = "GarryNash_Sale"

    url = "https://www.garrynash.com.au/pages/real-estate/results?widgetKey=158597&context=listings&returnAs=markup&listing_category=residential&listing_sale_method=Sale&pg=1"
    ...
    def __init__(self, *args, **kwargs):
        super(GarryNash_Sale, self).__init__(*args, **kwargs)
        self.links = []
