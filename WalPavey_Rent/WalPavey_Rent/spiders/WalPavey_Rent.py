...
class WalPavey_Rent(scrapy.Spider):
    name = "WalPavey_Rent"

    url = "https://www.walpavey.com.au/properties-for-rent"
    ...
    def __init__(self, *args, **kwargs):
        super(WalPavey_Rent, self).__init__(*args, **kwargs)
        self.links = []
