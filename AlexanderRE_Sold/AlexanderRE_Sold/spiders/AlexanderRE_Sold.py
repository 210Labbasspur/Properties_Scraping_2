...
class AlexanderRE_Sold(scrapy.Spider):
    name = "AlexanderRE_Sold"

    url = "https://www.alexanderrealestate.com.au/buy/sold-properties/"
    ...
    def __init__(self, *args, **kwargs):
        super(AlexanderRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
