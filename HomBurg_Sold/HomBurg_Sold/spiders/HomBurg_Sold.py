...
class HomBurg_Sold(scrapy.Spider):
    name = "HomBurg_Sold"

    url = "https://homburg.com.au/ajax-search-listings?page=1&type=Sold"
    ...
    def __init__(self, *args, **kwargs):
        super(HomBurg_Sold, self).__init__(*args, **kwargs)
        self.links = []
