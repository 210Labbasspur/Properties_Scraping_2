...
class AlexanderRE_Sale(scrapy.Spider):
    name = "AlexanderRE_Sale"

    url = "https://www.alexanderrealestate.com.au/buy/properties-for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(AlexanderRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
