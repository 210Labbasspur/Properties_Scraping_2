...
class DelRE_Sold(scrapy.Spider):
    name = "DelRE_Sold"

    url = "https://www.delrealestate.com.au/search/?show_in_sale=true&sold=1&pageno={}"
    ...
    def __init__(self, *args, **kwargs):
        super(DelRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
