...
class Fitzsimmons_Rent(scrapy.Spider):
    name = "Fitzsimmons_Rent"
    url = 'https://www.fitzsimmonsre.com.au/wp-admin/admin-ajax.php'
    prefix = "https://www.fitzsimmonsre.com.au"
    headers = {
    ...
    'atts[property_type]': 'Apartment,House,Unit,Townhouse,Retail',
    ...
    def __init__(self, *args, **kwargs):
        super(Fitzsimmons_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2067)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Fitzsimmons Real Estate'
