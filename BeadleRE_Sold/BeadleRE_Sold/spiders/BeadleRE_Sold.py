...
class BeadleRE_Sold(scrapy.Spider):
    name = 'BeadleRE_Sold'
    prefix = 'https://www.beadlerealestate.com.au'
    url = 'https://www.beadlerealestate.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(BeadleRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
