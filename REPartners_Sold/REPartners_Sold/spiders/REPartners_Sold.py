...
class REPartners_Sold(scrapy.Spider):
    name = "REPartners_Sold"

    url = "https://www.realestatepartners.net.au/type/sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(REPartners_Sold, self).__init__(*args, **kwargs)
        self.links = []
