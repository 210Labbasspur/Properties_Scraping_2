...
class ResiderRE_Sale(scrapy.Spider):
    name = "ResiderRE_Sale"

    url = "https://www.residerre.com.au/buy/properties-for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(ResiderRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
