...
class MaddisonEA_Sale(scrapy.Spider):
    name = "MaddisonEA_Sale"

    url = "https://www.maddisonestateagents.com.au/buy"
    ...
    def __init__(self, *args, **kwargs):
        super(MaddisonEA_Sale, self).__init__(*args, **kwargs)
        self.links = []
