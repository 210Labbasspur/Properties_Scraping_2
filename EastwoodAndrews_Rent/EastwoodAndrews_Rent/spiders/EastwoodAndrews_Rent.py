...
class EastwoodAndrews_Rent(scrapy.Spider):
    name = "EastwoodAndrews_Rent"

    url = "https://www.eastwoodandrews.com.au/renting/properties-for-lease/"
    prefix = "https://www.eastwoodandrews.com.au"
    headers = {
    ...
    count = 1
    db = 'EastwoodAndrews'
    collection = 'EastwoodAndrews_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(EastwoodAndrews_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2582)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Eastwood Andrews'
