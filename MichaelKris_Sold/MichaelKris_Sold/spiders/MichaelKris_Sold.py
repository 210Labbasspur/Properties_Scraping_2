...
class MichaelKris_Sold(scrapy.Spider):
    name = "MichaelKris_Sold"

    url = "https://www.michaelkris.com.au/selling/recent-sales/"
    ...
    def __init__(self, *args, **kwargs):
        super(MichaelKris_Sold, self).__init__(*args, **kwargs)
        self.links = []
