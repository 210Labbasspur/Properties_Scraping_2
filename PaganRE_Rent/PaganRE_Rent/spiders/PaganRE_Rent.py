...
class PaganRE_Rent(scrapy.Spider):
    name = "PaganRE_Rent"

    url = "https://www.paganrealestate.com.au/data/results/?listing_category=residential&listing_sale_method=Lease&pg={}"
    ...
    def __init__(self, *args, **kwargs):
        super(PaganRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
