...
class Wodonga_Sale(scrapy.Spider):
    name = "Wodonga_Sale"

    url = "https://www.wodongarealestate.com.au/buying/properties-for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(Wodonga_Sale, self).__init__(*args, **kwargs)
        self.links = []
