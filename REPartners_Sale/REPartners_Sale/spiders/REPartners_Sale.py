...
class REPartners_Sale(scrapy.Spider):
    name = "REPartners_Sale"

    url = "https://www.realestatepartners.net.au/properties/"
    ...
    def __init__(self, *args, **kwargs):
        super(REPartners_Sale, self).__init__(*args, **kwargs)
        self.links = []
