...
class Galldon_Sold(scrapy.Spider):
    name = "Galldon_Sold"

    url = "https://www.galldon.com.au/pages/real-estate/results?widgetKey=216394&context=listings&returnAs=markup&listing_sale_method=sale&status=sold&display_sale_method=Sold&pg=1"
    ...
    def __init__(self, *args, **kwargs):
        super(Galldon_Sold, self).__init__(*args, **kwargs)
        self.links = []
