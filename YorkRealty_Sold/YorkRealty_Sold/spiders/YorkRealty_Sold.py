...
class YorkRealty_Sold(scrapy.Spider):
    name = "YorkRealty_Sold"
    url = ('https://www.yorkrealty.com.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bpost_type%5D%5Btype%5D=equal&query%5Bcount%5D%5Bvalue%5D=20&query%5Bcount%5D%5Btype%5D=equal&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Borderby%5D%5Btype%5D=equal&query%5Bmeta_key%5D%5Bvalue%5D=saleDate&query%5Bmeta_key%5D%5Btype%5D=equal&query%5Bsold%5D%5Bvalue%5D=1&query%5Bsold%5D%5Btype%5D=equal&query%5BsaleOrRental%5D%5Bvalue%5D=Sale&query%5BsaleOrRental%5D%5Btype%5D=equal&query'
           '%5Bpaged%5D%5Bvalue%5D={}&query%5Bpaged%5D%5Btype%5D=equal&query%5Border%5D%5Bvalue%5D=saleDate-desc&query%5Border%5D%5Btype%5D=equal')
    ...
    count = 1
    db = 'YorkRealty'
    collection = 'YorkRealty_Sold'
    bucket_prefix = f'Images6'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(YorkRealty_Sold, self).__init__(*args, **kwargs)
        self.links = []
