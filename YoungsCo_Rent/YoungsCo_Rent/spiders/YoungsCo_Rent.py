...
class YoungsCo_Rent(scrapy.Spider):
    name = 'YoungsCo_Rent'
    url = "https://www.youngsandco.com.au/propertiesJson?callback=angular.callbacks._0&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=rental"
    ...
    count = 1
    db = 'YoungsCo'
    collection = 'YoungsCo_Rent'
    bucket_prefix = f'D_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(YoungsCo_Rent, self).__init__(*args, **kwargs)
        self.links = []
