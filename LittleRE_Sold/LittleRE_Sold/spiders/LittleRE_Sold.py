...
class LittleRE_Sold(scrapy.Spider):
    name = "LittleRE_Sold"
    ...
    params = "query=&maxValuesPerFacet=20&page={}&facets=%5B%22location.state%22%2C%22surroundingSuburbs%22%2C%22suburbStateFacet%22%2C%22location.state%22%2C%22location.region%22%2C%22title%22%2C%22type%22%2C%22category%22%2C%22price%22%2C%22bedrooms%22%2C%22bathrooms%22%2C%22carports%22%5D&tagFilters="
    data = {
          "requests": [
            {
              "indexName": "soldProperties",
              "params": "query=&maxValuesPerFacet=20&page={}&facets=%5B%22location.state%22%2C%22surroundingSuburbs%22%2C%22suburbStateFacet%22%2C%22location.state%22%2C%22location.region%22%2C%22title%22%2C%22type%22%2C%22category%22%2C%22price%22%2C%22bedrooms%22%2C%22bathrooms%22%2C%22carports%22%5D&tagFilters="
            }
          ]
        }
    ...
    def __init__(self, *args, **kwargs):
        super(LittleRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
