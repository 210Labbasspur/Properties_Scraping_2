...
class HarrisWood_Sale(scrapy.Spider):
    name = "HarrisWood_Sale"

    url = "https://www.harriswood.com.au/buy/"
    ...
    def __init__(self, *args, **kwargs):
        super(HarrisWood_Sale, self).__init__(*args, **kwargs)
        self.links = []
