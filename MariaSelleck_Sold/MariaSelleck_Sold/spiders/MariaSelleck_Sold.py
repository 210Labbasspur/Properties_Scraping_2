...
class MariaSelleck_Sold(scrapy.Spider):
    name = 'MariaSelleck_Sold'
    prefix = 'https://www.mariaselleck.com.au'
    url = "https://www.mariaselleck.com.au/sell/recent-sales/"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(MariaSelleck_Sold, self).__init__(*args, **kwargs)
        self.links = []
