...
class BenallaRE_Sold(scrapy.Spider):
    name = 'BenallaRE_Sold'
    prefix = 'https://www.benallarealestate.net.au'
    url = 'https://www.benallarealestate.net.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(BenallaRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
