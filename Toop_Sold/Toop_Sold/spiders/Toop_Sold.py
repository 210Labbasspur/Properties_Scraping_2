...
class Toop_Sold(scrapy.Spider):
    name = "Toop_Sold"

    url = "https://mcfygsw91e-1.algolianet.com/1/indexes/*/queries?x-algolia-api-key=edc54929277cbfdb894d1beb36029e4e&x-algolia-application-id=MCFYGSW91E&x-user-agent=Algolia%20for%20vanilla%20JavaScript%203.3.0"
    ...
    def __init__(self, *args, **kwargs):
        super(Toop_Sold, self).__init__(*args, **kwargs)
        self.links = []
