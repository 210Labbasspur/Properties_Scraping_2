...
class YoungsCo_Sale(scrapy.Spider):
    name = 'YoungsCo_Sale'
    url = "https://www.youngsandco.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=residential"
    ...
    count = 1
    db = 'YoungsCo'
    collection = 'YoungsCo_Sale'
    bucket_prefix = f'D_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(YoungsCo_Sale, self).__init__(*args, **kwargs)
        self.links = []
