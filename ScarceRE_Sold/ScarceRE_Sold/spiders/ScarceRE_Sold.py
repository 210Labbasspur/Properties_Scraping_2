...
class ScarceRE_Sold(scrapy.Spider):
    name = 'ScarceRE_Sold'
    prefix = 'https://www.scarce.com.au'
    url = 'https://www.scarce.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(ScarceRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
