...
class SGLRealEstate_Rent(scrapy.Spider):
    name = "SGLRealEstate_Rent"

    url = "https://sglrealestate.com.au/rent/"
    ...
    def __init__(self, *args, **kwargs):
        super(SGLRealEstate_Rent, self).__init__(*args, **kwargs)
        self.links = []
