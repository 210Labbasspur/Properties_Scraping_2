...
class HomeByHolly_Sold(scrapy.Spider):
    name = "HomeByHolly_Sold"

    url = "https://homebyholly.com.au/sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(HomeByHolly_Sold, self).__init__(*args, **kwargs)
        self.links = []
