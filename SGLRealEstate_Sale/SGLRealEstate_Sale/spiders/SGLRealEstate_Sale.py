...
class SGLRealEstate_Sale(scrapy.Spider):
    name = "SGLRealEstate_Sale"

    url = "https://sglrealestate.com.au/buy/"
    ...
    def __init__(self, *args, **kwargs):
        super(SGLRealEstate_Sale, self).__init__(*args, **kwargs)
        self.links = []
