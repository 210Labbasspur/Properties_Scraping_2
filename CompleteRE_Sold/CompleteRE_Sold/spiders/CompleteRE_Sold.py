...
class CompleteRE_Sold(scrapy.Spider):
    name = "CompleteRE_Sold"

    url = "https://www.completerealestate.net.au/sell/"
    ...
    def __init__(self, *args, **kwargs):
        super(CompleteRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
