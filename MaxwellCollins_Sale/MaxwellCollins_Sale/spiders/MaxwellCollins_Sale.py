...
class MaxwellCollins_Sale(scrapy.Spider):
    name = "MaxwellCollins_Sale"

    url = "https://www.maxwellcollins.com.au/buy/search-results/"
    ...
    count = 1
    db = 'MaxwellCollins'
    collection = 'MaxwellCollins_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(MaxwellCollins_Sale, self).__init__(*args, **kwargs)
        self.links = []
