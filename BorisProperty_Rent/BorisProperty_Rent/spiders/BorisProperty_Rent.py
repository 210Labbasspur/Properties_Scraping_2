...
class BorisProperty_Rent(scrapy.Spider):
    name = 'BorisProperty_Rent'
    url = "https://www.borisproperty.com.au/for-rent/listed-properties/"
    prefix = 'https://www.borisproperty.com.au'
    headers = {
    ...
    count = 1
    db = 'BorisProperty'
    collection = 'BorisProperty_Rent'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(BorisProperty_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2406)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Boris Property'
