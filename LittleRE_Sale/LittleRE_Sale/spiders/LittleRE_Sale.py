...
class LittleRE_Sale(scrapy.Spider):
    name = "LittleRE_Sale"
  ...
  "requests": [
    ...
    {
      "indexName": "properties_suburb",
      "params": "query=&maxValuesPerFacet=20&page=0&hitsPerPage=1&attributesToRetrieve=%5B%5D&attributesToHighlight=%5B%5D&attributesToSnippet=%5B%5D&tagFilters=&analytics=false&clickAnalytics=false&facets=propertyStatus&facetFilters=%5B%5B%22type%3Abuy%22%2C%22type%3Aland%22%5D%5D"
    },
    {
      "indexName": "properties_suburb",
    ...
    def __init__(self, *args, **kwargs):
        super(LittleRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
