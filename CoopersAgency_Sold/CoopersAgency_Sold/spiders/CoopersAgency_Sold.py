...
class CoopersAgency_Sold(scrapy.Spider):
    name = "CoopersAgency_Sold"

    url = "https://coopers.agency/sold-properties"
    ...
    def __init__(self, *args, **kwargs):
        super(CoopersAgency_Sold, self).__init__(*args, **kwargs)
        self.links = []
