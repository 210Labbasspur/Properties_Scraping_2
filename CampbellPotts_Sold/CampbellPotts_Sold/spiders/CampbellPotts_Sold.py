...
class CampbellPotts_Sold(scrapy.Spider):
    name = "CampbellPotts_Sold"

    url = "http://campbellpotts.com.au/recently-sold"
    ...
    def __init__(self, *args, **kwargs):
        super(CampbellPotts_Sold, self).__init__(*args, **kwargs)
        self.links = []
