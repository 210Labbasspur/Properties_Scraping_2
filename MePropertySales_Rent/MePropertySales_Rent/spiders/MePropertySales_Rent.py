...
class MePropertySales_Rent(scrapy.Spider):
    name = "MePropertySales_Rent"
    url = "https://mepropertysales.com.au/listings/?saleOrRental=Rental&rental_period=week&status=available"
    ...
    count = 1
    db = 'MePropertySales'
    collection = 'MePropertySales_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(MePropertySales_Rent, self).__init__(*args, **kwargs)
        self.links = []
