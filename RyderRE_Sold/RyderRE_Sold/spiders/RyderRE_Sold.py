...
class RyderRE_Sold(scrapy.Spider):
    name = "RyderRE_Sold"

    url = "https://www.ryderrealestate.com.au/search/?sold=1&show_in_sale=true&order_by=sold_date&order=desc"
    ...
    def __init__(self, *args, **kwargs):
        super(RyderRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
