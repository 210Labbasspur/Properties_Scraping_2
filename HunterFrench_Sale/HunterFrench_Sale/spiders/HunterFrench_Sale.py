...
class HunterFrench_Sale(scrapy.Spider):
    name = "HunterFrench_Sale"

    url = "https://www.hunterfrench.com.au/for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(HunterFrench_Sale, self).__init__(*args, **kwargs)
        self.links = []
