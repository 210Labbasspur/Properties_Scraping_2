...
class OCRE_Rent(scrapy.Spider):
    name = "OCRE_Rent"

    url = "https://ocre.com.au/property/?action=epl_search&post_type=rental&property_status=current"
    ...
    def __init__(self, *args, **kwargs):
        super(OCRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
