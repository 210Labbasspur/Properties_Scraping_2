...
class MandyLee_Rent(scrapy.Spider):
    name = 'MandyLee_Rent'
    prefix = 'https://www.mandylee.com.au'
    url = "https://www.mandylee.com.au/renting/properties-for-lease/"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(MandyLee_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2679)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Mandy Lee'
