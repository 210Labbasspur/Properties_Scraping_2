...
class AltairProperty_Sold(scrapy.Spider):
    name = "AltairProperty_Sold"
    ...
    count = 1
    db = 'AltairProperty'
    collection = 'AltairProperty_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(AltairProperty_Sold, self).__init__(*args, **kwargs)
        self.links = []
