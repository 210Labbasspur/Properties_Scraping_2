...
class CharlesStewart_Rent(scrapy.Spider):
    name = "CharlesStewart_Rent"

    url = "https://charlesstewart.com.au/rental-management/rental-properties"
    ...
    count = 1
    db = 'CharlesStewart'
    collection = 'CharlesStewart_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(CharlesStewart_Rent, self).__init__(*args, **kwargs)
        self.links = []
