...
class TopRealty_Sold(scrapy.Spider):
    name = 'TopRealty_Sold'
    url = 'https://www.toprealty.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=96&sort=d_sold%20desc&web_stage=sold'
    ...
    def __init__(self, *args, **kwargs):
        super(TopRealty_Sold, self).__init__(*args, **kwargs)
        self.links = []
