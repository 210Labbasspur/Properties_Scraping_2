...
class WilsonPartners_Rent(scrapy.Spider):
    name = "WilsonPartners_Rent"

    url = "https://www.wilsonpartners.com.au/renting/search-rentals/"
    ...
    count = 1
    db = 'WilsonPartners'
    collection = 'WilsonPartners_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(WilsonPartners_Rent, self).__init__(*args, **kwargs)
        self.links = []
