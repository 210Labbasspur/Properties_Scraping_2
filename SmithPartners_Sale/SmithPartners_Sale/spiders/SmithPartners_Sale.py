...
class SmithPartners_Sale(scrapy.Spider):
    name = "SmithPartners_Sale"
    url = "https://smithpartnersrealestate.com.au/listings?saleOrRental=Sale&status=available_under_contract&sortby=dateListed-desc"
    prefix = "https://smithpartnersrealestate.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(SmithPartners_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def parse(self, response):
        ...
        for each_url in all_links:
            each_url = f'https://smithpartnersrealestate.com.au{each_url}'
        ...
        for property_url in all_links:
            property_url = f'https://smithpartnersrealestate.com.au{property_url}'
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2469)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Smith Partners Real Estate'
