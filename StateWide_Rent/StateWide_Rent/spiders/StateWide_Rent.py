...
class StateWide_Rent(scrapy.Spider):
    name = "StateWide_Rent"

    url = "https://www.statewideproperty.net/rent/properties-for-rent"
    ...
    def __init__(self, *args, **kwargs):
        super(StateWide_Rent, self).__init__(*args, **kwargs)
        self.links = []
