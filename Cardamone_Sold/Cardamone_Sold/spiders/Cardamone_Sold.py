...
class Cardamone_Sold(scrapy.Spider):
    name = "Cardamone_Sold"

    url = "https://www.cardamonerealestate.com.au/properties/sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(Cardamone_Sold, self).__init__(*args, **kwargs)
        self.links = []
