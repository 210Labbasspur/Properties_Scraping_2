...
class MaxwellCollins_Sold(scrapy.Spider):
    name = "MaxwellCollins_Sold"

    url = "https://www.maxwellcollins.com.au/sell/recently-sold/"
    ...
    count = 1
    db = 'MaxwellCollins'
    collection = 'MaxwellCollins_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(MaxwellCollins_Sold, self).__init__(*args, **kwargs)
        self.links = []
