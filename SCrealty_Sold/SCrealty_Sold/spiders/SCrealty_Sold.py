...
class SCrealty_Sold(scrapy.Spider):
    name = 'SCrealty_Sold'
    url = "https://www.screalty.com.au/recent-sales/"
    # url = "https://www.screalty.com.au/buying/properties-for-sale/"
    prefix = 'https://www.screalty.com.au'
    headers = {
    ...
    count = 1
    db = 'SCrealty'
    collection = 'SCrealty_Sold'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(SCrealty_Sold, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2375)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'South Coast Realty'
