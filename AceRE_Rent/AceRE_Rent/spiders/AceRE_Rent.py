...
class AceRE_Rent(scrapy.Spider):
    name = "AceRE_Rent"

    url = "https://www.acerealestate.com.au/property-status/for-rent/"
    ...
    def __init__(self, *args, **kwargs):
        super(AceRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
