...
class TheCoastRE_Sold(scrapy.Spider):
    name = "TheCoastRE_Sold"
    url = "https://thecoast.com.au/listings/?saleOrRental=Sale&status=sold&sortby=saleDate-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(TheCoastRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
