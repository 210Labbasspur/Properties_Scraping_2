...
class Burnham_Rent(scrapy.Spider):
    name = "Burnham_Rent"
    url = "https://burnham.com.au/listings?saleOrRental=Rental&status=available_under_contract&sortby=dateListed-desc"
    prefix = "https://burnham.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(Burnham_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def parse(self, response):
        ...
        for each_url in all_links:
            each_url = f'https://burnham.com.au{each_url}'
        ...
        for property_url in all_links:
            property_url = f'https://burnham.com.au{property_url}'
