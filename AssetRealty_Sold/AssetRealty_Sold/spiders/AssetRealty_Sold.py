...
class AssetRealty_Sold(scrapy.Spider):
    name = "AssetRealty_Sold"

    url = "https://www.assetrealty.com.au/sell/sold-properties/"
    ...
    def __init__(self, *args, **kwargs):
        super(AssetRealty_Sold, self).__init__(*args, **kwargs)
        self.links = []
