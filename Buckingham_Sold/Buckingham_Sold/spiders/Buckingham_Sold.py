...
class Buckingham_Sold(scrapy.Spider):
    name = "Buckingham_Sold"

    url = "https://www.buckinghamandcompany.com.au/sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(Buckingham_Sold, self).__init__(*args, **kwargs)
        self.links = []
