...
class UrbanWARE_Sold(scrapy.Spider):
    name = 'UrbanWARE_Sold'
    prefix = 'https://www.urbanwa.com.au'
    url = "https://www.urbanwa.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold"
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(UrbanWARE_Sold, self).__init__(*args, **kwargs)
        self.links = []
