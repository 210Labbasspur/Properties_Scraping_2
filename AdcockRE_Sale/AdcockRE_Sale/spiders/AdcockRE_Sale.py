...
class AdcockRE_Sale(scrapy.Spider):
    name = "AdcockRE_Sale"

    url = "https://www.adcock.com.au/buy/properties-for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(AdcockRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
