...
class AssetRealty_Rent(scrapy.Spider):
    name = "AssetRealty_Rent"

    url = "https://www.assetrealty.com.au/lease/residential/"
    ...
    def __init__(self, *args, **kwargs):
        super(AssetRealty_Rent, self).__init__(*args, **kwargs)
        self.links = []
