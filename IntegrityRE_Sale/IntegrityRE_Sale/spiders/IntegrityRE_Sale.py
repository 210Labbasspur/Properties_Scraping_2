...
class IntegrityRE_Sale(scrapy.Spider):
    name = 'IntegrityRE_Sale'
    prefix = 'https://www.integrityrealestate.com.au'
    url = 'https://www.integrityrealestate.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat0=residential&categories0=House&categories1=Rural&categories2=Unit&categories3=Townhouse&categories4=AcreageSemi-rural&categories5=DuplexSemi-detached&categories6=HouseAndLandPackage'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(IntegrityRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def Detail_parse(self, mini_data,full_data):
        ...
        if detail_page_url not in database_sale_matching_url:
            ...
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2803)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Integrity Yarra Valley & Kinglake Ranges'
