...
class NorthWestRE_Sale(scrapy.Spider):
    name = "NorthWestRE_Sale"

    url = "https://www.northwestrealestate.net.au/buy"
    ...
    def __init__(self, *args, **kwargs):
        super(NorthWestRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
