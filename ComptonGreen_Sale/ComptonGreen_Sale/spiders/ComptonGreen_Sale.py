...
class ComptonGreen_Sale(scrapy.Spider):
    name = "ComptonGreen_Sale"

    url = "https://www.comptongreen.com.au/buy"
    ...
    def __init__(self, *args, **kwargs):
        super(ComptonGreen_Sale, self).__init__(*args, **kwargs)
        self.links = []
