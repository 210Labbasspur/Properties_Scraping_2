...
class ChangingPlaces_Sale(scrapy.Spider):
    name = "ChangingPlaces_Sale"

    url = "https://changingplaces.com.au/buy/buy/"
    ...
    count = 1
    db = 'ChangingPlaces'
    collection = 'ChangingPlaces_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(ChangingPlaces_Sale, self).__init__(*args, **kwargs)
        self.links = []
