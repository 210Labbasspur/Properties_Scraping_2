...
class MyrtlefordRE_Sale(scrapy.Spider):
    name = "MyrtlefordRE_Sale"

    url = "https://www.myrtlefordrel.com.au/buy/residential-sales/"
    ...
    def __init__(self, *args, **kwargs):
        super(MyrtlefordRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
