...
class Fletchers_Sold(scrapy.Spider):
    name = "Fletchers_Sold"

    url = "https://fletchers.net.au/recent-sales?async=1&nomap=1&ac=&page=1&office=&orderby=&lifestyle=&min=0&max=&beds=0&baths=0&cars=0&categories=&types=&radius=1&extras=&searchtype=sale"
    ...
    def __init__(self, *args, **kwargs):
        super(Fletchers_Sold, self).__init__(*args, **kwargs)
        self.links = []
