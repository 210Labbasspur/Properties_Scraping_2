...
class BorisProperty_Sold(scrapy.Spider):
    name = 'BorisProperty_Sold'
    url = "https://www.borisproperty.com.au/for-sale/sold-properties/"
    ...
    count = 1
    db = 'BorisProperty'
    collection = 'BorisProperty_Sold'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(BorisProperty_Sold, self).__init__(*args, **kwargs)
        self.links = []
