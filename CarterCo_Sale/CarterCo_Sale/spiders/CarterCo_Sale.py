...
class CarterCo_Sale(scrapy.Spider):
    name = "CarterCo_Sale"

    url = "https://www.carterandcoagents.com.au/buying/properties-for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(CarterCo_Sale, self).__init__(*args, **kwargs)
        self.links = []
