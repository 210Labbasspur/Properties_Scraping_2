...
class WilsonsWarrnambool_Sale(scrapy.Spider):
    name = "WilsonsWarrnambool_Sale"

    url = "https://wilsonswarrnambool.com.au/buying/properties-for-sale/"
    ...
    collection = 'WilsonsWarrnambool_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(WilsonsWarrnambool_Sale, self).__init__(*args, **kwargs)
        self.links = []
