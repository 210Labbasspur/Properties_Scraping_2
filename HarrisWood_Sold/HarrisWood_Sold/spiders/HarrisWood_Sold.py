...
class HarrisWood_Sold(scrapy.Spider):
    name = "HarrisWood_Sold"

    url = "https://www.harriswood.com.au/sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(HarrisWood_Sold, self).__init__(*args, **kwargs)
        self.links = []
