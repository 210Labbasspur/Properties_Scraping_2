...
class Galldon_Rent(scrapy.Spider):
    name = "Galldon_Rent"

    url = "https://www.galldon.com.au/pages/real-estate/results?listing_sale_method=lease&status=&display_sale_method=Rent&listing_category=residential"
    ...
    def __init__(self, *args, **kwargs):
        super(Galldon_Rent, self).__init__(*args, **kwargs)
        self.links = []
