...
class Bruse_Sale(scrapy.Spider):
    name = 'Bruse_Sale'
    # url = "https://www.bruse.com.au/selling/recent-sales/"
    url = "https://www.bruse.com.au/buying/properties-for-sale/"
    prefix = 'https://www.bruse.com.au'
    headers = {
    ...
    count = 1
    db = 'SCrealty'
    collection = 'Bruse_Sale'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(Bruse_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2407)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Bruse Real Estate'
