...
class AdcockRE_Rent(scrapy.Spider):
    name = "AdcockRE_Rent"

    url = "https://www.adcock.com.au/rent/properties-for-rent/"
    prefix = "https://www.adcock.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(AdcockRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2386)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Adcock Real Estate'
