...
class Lavis_Rent(scrapy.Spider):
    name = 'Lavis_Rent'
    url = 'https://www.lavisrealestate.com.au/propertiesJson?callback=angular.callbacks._0&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=rental'
    ...
    def __init__(self, *args, **kwargs):
        super(Lavis_Rent, self).__init__(*args, **kwargs)
        self.links = []
