...
class EdgeRealty_Sale(scrapy.Spider):
    name = "EdgeRealty_Sale"

    url = "https://www.edgerealty.com.au/buying/properties-for-sale/"
    prefix = "https://www.edgerealty.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(EdgeRealty_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2416)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Edge Realty'
