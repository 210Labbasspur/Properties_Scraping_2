...
class MariaSelleck_Sale(scrapy.Spider):
    name = 'MariaSelleck_Sale'
    prefix = 'https://www.mariaselleck.com.au'
    url = "https://www.mariaselleck.com.au/buy/properties-for-sale/"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(MariaSelleck_Sale, self).__init__(*args, **kwargs)
        self.links = []
