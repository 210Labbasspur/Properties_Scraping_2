...
class NickJohnStone_Sold(scrapy.Spider):
    name = 'NickJohnStone_Sold'
    prefix = 'https://www.nickjohnstone.com.au'
    url = "https://www.nickjohnstone.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold"
    headers = {
        'accept': '*/*',
    ...
    count = 1
    db = 'NickJohnStone'
    collection = 'NickJohnStone_Sold'
    bucket_prefix = f'D_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(NickJohnStone_Sold, self).__init__(*args, **kwargs)
        self.links = []
