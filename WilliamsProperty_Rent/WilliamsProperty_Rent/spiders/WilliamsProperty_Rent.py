...
class WilliamsProperty_Rent(scrapy.Spider):
    name = 'WilliamsProperty_Rent'
    url = "https://www.williamsproperty.com.au/renting/properties-for-lease/"
    ...
    count = 1
    db = 'WilliamsProperty'
    collection = 'WilliamsProperty_Rent'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(WilliamsProperty_Rent, self).__init__(*args, **kwargs)
        self.links = []
