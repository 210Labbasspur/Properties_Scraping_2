...
class MorrisonKleeman_Sale(scrapy.Spider):
    name = "MorrisonKleeman_Sale"

    url = "https://www.morrisonkleeman.com.au/search-list?type=Buy"
    ...
    count = 1
    db = 'MorrisonKleeman'
    collection = 'MorrisonKleeman_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(MorrisonKleeman_Sale, self).__init__(*args, **kwargs)
        self.links = []
