...
class Rendina_Sale(scrapy.Spider):
    name = "Rendina_Sale"

    url = "https://www.rendina.com.au/pages/real-estate/results?widgetKey=61441&context=listings&returnAs=markup&listing_category=residential&listing_sale_method=sale&pg=1"
    ...
    def __init__(self, *args, **kwargs):
        super(Rendina_Sale, self).__init__(*args, **kwargs)
        self.links = []
