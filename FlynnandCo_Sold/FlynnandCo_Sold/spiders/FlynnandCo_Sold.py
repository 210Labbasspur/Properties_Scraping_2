...
class FlynnandCo_Sold(scrapy.Spider):
    name = "FlynnandCo_Sold"
    url = "https://flynnandco.com.au/listings?saleOrRental=Sale&sortby=saleDate-desc&status=sold"
    ...
    def __init__(self, *args, **kwargs):
        super(FlynnandCo_Sold, self).__init__(*args, **kwargs)
        self.links = []
