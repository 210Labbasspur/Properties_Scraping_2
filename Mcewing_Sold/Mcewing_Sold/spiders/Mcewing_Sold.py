...
class Mcewing_Sold(scrapy.Spider):
    name = "Mcewing_Sold"
    url = 'https://www.mcewingpartners.com/wp-admin/admin-ajax.php'
    prefix = "https://www.mcewingpartners.com"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(Mcewing_Sold, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2732)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Mcewing Partners'
