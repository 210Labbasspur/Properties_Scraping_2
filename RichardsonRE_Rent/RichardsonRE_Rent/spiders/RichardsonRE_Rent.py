...
class RichardsonRE_Rent(scrapy.Spider):
    name = "RichardsonRE_Rent"

    url = "https://hfrcolac.com.au/rent"
    ...
    def __init__(self, *args, **kwargs):
        super(RichardsonRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
