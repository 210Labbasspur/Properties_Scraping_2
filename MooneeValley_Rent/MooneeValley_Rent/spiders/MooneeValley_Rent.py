...
class MooneeValley_Rent(scrapy.Spider):
    name = 'MooneeValley_Rent'
    url = "https://www.mooneevalley.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=rental"
    ...
    count = 1
    db = 'MooneeValley'
    collection = 'MooneeValley_Rent'
    bucket_prefix = f'D_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(MooneeValley_Rent, self).__init__(*args, **kwargs)
        self.links = []
