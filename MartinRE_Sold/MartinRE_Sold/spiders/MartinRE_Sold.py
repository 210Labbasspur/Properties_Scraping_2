...
class MartinRE_Sold(scrapy.Spider):
    name = 'MartinRE_Sold'
    url = "https://www.martinrealestate.com.au/selling/recent-sales/"
    ...
    count = 1
    db = 'MartinRE'
    collection = 'MartinRE_Sold'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(MartinRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
