...
class Monaghans_Sale(scrapy.Spider):
    name = 'Monaghans_Sale'
    url = "https://www.monaghansrealestate.com/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=residential"
    prefix = 'https://www.monaghansrealestate.com'
    headers = {
        'accept': '*/*',
    ...
    count = 1
    db = 'Monaghans'
    collection = 'Monaghans_Sale'
    bucket_prefix = f'D_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(Monaghans_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def Detail_parse(self, mini_data,full_data):
        ...
        if detail_page_url not in database_sale_matching_url:
            ...
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2616)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Monaghan\'s Real Estate'
