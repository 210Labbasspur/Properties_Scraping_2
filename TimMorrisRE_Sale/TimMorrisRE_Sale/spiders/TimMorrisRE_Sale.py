...
class TimMorrisRE_Sale(scrapy.Spider):
    name = 'TimMorrisRE_Sale'
    url = "https://www.timmorris.com.au/buy/properties-for-sale/"
    ...
    count = 1
    db = 'TimMorrisRE'
    collection = 'TimMorrisRE_Sale'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(TimMorrisRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
