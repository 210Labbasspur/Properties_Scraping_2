...
class LuxeAgents_Rent(scrapy.Spider):
    name = "LuxeAgents_Rent"

    url = "https://www.luxeagents.com.au/data/results/?listing_category=Residential&listing_sale_method=Lease&pg={}"
    ...
    def __init__(self, *args, **kwargs):
        super(LuxeAgents_Rent, self).__init__(*args, **kwargs)
        self.links = []
