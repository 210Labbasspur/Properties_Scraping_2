...
class InsiteRE_Rent(scrapy.Spider):
    name = "InsiteRE_Rent"
    url = "https://insiterealestate.com.au/listings/?saleOrRental=Rental&rental_period=week&status=available&viewType=gallery&sortby=dateListed-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(InsiteRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
