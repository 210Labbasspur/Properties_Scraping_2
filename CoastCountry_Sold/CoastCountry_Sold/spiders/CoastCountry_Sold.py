...
class CoastCountry_Sold(scrapy.Spider):
    name = "CoastCountry_Sold"

    url = "https://www.coastandcountryfn.com.au/sell/recent-sales/"
    ...
    def __init__(self, *args, **kwargs):
        super(CoastCountry_Sold, self).__init__(*args, **kwargs)
        self.links = []
