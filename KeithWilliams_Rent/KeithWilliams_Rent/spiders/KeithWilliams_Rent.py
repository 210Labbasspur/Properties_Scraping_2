...
class KeithWilliams_Rent(scrapy.Spider):
    name = "KeithWilliams_Rent"
    url = ('https://www.keithwilliams.com.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bcount%5D%5Bvalue%5D=20&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Bmeta_key%5D%5Bvalue%5D=dateListed&query%5Bsold%5D%5Bvalue%5D=0&query%5BsaleOrRental%5D%5Bvalue%5D=rental&query%5BsaleOrRental%5D%5Btype%5D=equal&query%5Btype%5D%5Bvalue%5D=residential&query%5Btype%5D%5Btype%5D=equal&query%5Bdoing_wp_cron%5D%5Bvalue%5D=1739608993.8268899917602539062500&query%5Bdoing_wp_cron%5D%5Btype%5D=equal&'
           'query%5Bpaged%5D%5Bvalue%5D={}')
    prefix = "https://www.keithwilliams.com.au"
    headers = {
    ...
    count = 1
    db = 'KeithWilliams'
    collection = 'KeithWilliams_Rent'
    bucket_prefix = f'Images6'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(KeithWilliams_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2591)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Keith Williams Real Estate'
