...
class BasePG_Sale(scrapy.Spider):
    name = "BasePG_Sale"
    url = "https://basepropertygroup.com.au/listings?buildareaunit=&cars=&category=&externalID=&features=&landareaunit=&maxbaths=&maxbeds=&maxbuildarea=&maxlandarea=&maxprice=&minbaths=&minbeds=&minbuildarea=&minlandarea=&minprice=&saleOrRental=Sale&sortby=dateListed-desc&status=available&suburbs=&type=residential"
    prefix = "https://basepropertygroup.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(BasePG_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def parse(self, response):
        ...
        for each_url in all_links:
            each_url = f'https://basepropertygroup.com.au{each_url}'
        ...
        for property_url in all_links:
            property_url = f'https://basepropertygroup.com.au{property_url}'
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(1972)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Base Property Group'
            ...
            item['Field81'] = response.xpath('//*[contains(text(),"Open Homes")]/following-sibling::*[1]/p/text()').get('').strip()
