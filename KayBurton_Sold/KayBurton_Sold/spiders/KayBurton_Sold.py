...
class KayBurton_Sold(scrapy.Spider):
    name = "KayBurton_Sold"

    url = "https://www.kayburton.com.au/sell/sold-properties/"
    ...
    def __init__(self, *args, **kwargs):
        super(KayBurton_Sold, self).__init__(*args, **kwargs)
        self.links = []
