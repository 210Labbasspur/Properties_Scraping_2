...
class GarryNash_Rent(scrapy.Spider):
    name = "GarryNash_Rent"

    url = "https://www.garrynash.com.au/pages/real-estate/results?listing_sale_method=rent&listing_category=residential"
    ...
    def __init__(self, *args, **kwargs):
        super(GarryNash_Rent, self).__init__(*args, **kwargs)
        self.links = []
