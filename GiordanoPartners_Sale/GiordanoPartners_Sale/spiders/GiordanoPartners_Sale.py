...
class GiordanoPartners_Sale(scrapy.Spider):
    name = "GiordanoPartners_Sale"

    url = "https://giordanopartners.com/properties-for-sale"
    ...
    count = 1
    db = 'GiordanoPartners'
    collection = 'GiordanoPartners_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(GiordanoPartners_Sale, self).__init__(*args, **kwargs)
        self.links = []
