##################          AreaSpecialistWyndhamCity_Sale
...
class AreaSpecialistWyndhamCity_Sale(scrapy.Spider):
    name = "AreaSpecialistWyndhamCity_Sale"

    url = "https://wyndhamcity.areaspecialist.com.au/data/results/?listing_sale_method=Sale&gallery=1&pg={}"
    ...
    collection = 'AreaSpecialistWyndhamCity_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(AreaSpecialistWyndhamCity_Sale, self).__init__(*args, **kwargs)
        self.links = []
