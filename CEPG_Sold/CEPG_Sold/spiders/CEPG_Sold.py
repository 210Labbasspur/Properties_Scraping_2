...
class CEPG_Sold(scrapy.Spider):
    name = "CEPG_Sold"
    url = "https://cepg.com.au/listings/?page=1&saleOrRental=Sale&rental_period=week&status=sold&viewType=gallery&sortby=saleDate-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(CEPG_Sold, self).__init__(*args, **kwargs)
        self.links = []
