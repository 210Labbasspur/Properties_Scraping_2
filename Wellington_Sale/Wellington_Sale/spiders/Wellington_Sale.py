...
class Wellington_Sale(scrapy.Spider):
    name = "Wellington_Sale"
    url = ('https://wellingtonrealestate.com.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bcount%5D%5Bvalue%5D=20&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Bmeta_key%5D%5Bvalue%5D=dateListed&query%5Bsold%5D%5Bvalue%5D=0&query%5BsaleOrRental%5D%5Bvalue%5D=Sale&query%5BsaleOrRental%5D%5Btype%5D=equal&query%5Border%5D%5Bvalue%5D=dateListed-desc&query%5Border%5D%5Btype%5D=equal&query%5Bextended%5D%5Bvalue%5D=0'
    ...
    count = 1
    db = 'Wellington'
    collection = 'Wellington_Sale'
    bucket_prefix = f'Images6'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(Wellington_Sale, self).__init__(*args, **kwargs)
        self.links = []
