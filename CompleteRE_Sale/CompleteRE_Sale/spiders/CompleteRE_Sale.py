...
class CompleteRE_Sale(scrapy.Spider):
    name = "CompleteRE_Sale"

    url = "https://www.completerealestate.net.au/buy/"
    ...
    def __init__(self, *args, **kwargs):
        super(CompleteRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
