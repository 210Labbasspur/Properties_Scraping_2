...
class BasePG_Rent(scrapy.Spider):
    name = "BasePG_Rent"
    url = "https://basepropertygroup.com.au/listings?saleOrRental=Rental&status=available_under_contract&sortby=dateListed-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(BasePG_Rent, self).__init__(*args, **kwargs)
        self.links = []
