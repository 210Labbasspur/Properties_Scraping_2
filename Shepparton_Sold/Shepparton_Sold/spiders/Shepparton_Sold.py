...
class Shepparton_Sold(scrapy.Spider):
    name = "Shepparton_Sold"

    url = "https://www.sheppartonrealestate.com.au/sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(Shepparton_Sold, self).__init__(*args, **kwargs)
        self.links = []
