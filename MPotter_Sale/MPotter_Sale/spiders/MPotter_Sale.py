...
class MPotter_Sale(scrapy.Spider):
    ...
    count = 1
    db = 'MPotter'
    collection = 'MPotter_Sale'
    bucket_prefix = f'Images6'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(MPotter_Sale, self).__init__(*args, **kwargs)
        self.links = []
