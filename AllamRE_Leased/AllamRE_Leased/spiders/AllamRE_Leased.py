...
class AllamRE_Leased(scrapy.Spider):
    name = "AllamRE_Leased"
    url = 'https://www.allamre.com.au/wp-admin/admin-ajax.php'
    prefix = "https://www.allamre.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(AllamRE_Leased, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(1448)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Allam Real Estate'
            ...
            item['Field8'] = response.xpath("//*[contains(@class,'las la-car')]/parent::*[1]/text()[2]").get('').strip()
