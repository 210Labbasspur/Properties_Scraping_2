...
class Burnham_Sale(scrapy.Spider):
    name = "Burnham_Sale"
    url = "https://burnham.com.au/listings?saleOrRental=Sale&status=available_under_contract&sortby=dateListed-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(Burnham_Sale, self).__init__(*args, **kwargs)
        self.links = []
