...
class ScottKimRE_Sale(scrapy.Spider):
    name = "ScottKimRE_Sale"

    url = "https://scottkim.com.au/property/"
    ...
    def __init__(self, *args, **kwargs):
        super(ScottKimRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
