...
class Buckingham_Rent(scrapy.Spider):
    name = "Buckingham_Rent"

    url = "https://www.buckinghamandcompany.com.au/properties-for-rent/"
    ...
    def __init__(self, *args, **kwargs):
        super(Buckingham_Rent, self).__init__(*args, **kwargs)
        self.links = []
