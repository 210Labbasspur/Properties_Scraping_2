...
class ChangingPlaces_Rent(scrapy.Spider):
    name = "ChangingPlaces_Rent"

    url = "https://changingplaces.com.au/rent/properties-for-lease/"
    ...
    count = 1
    db = 'ChangingPlaces'
    collection = 'ChangingPlaces_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(ChangingPlaces_Rent, self).__init__(*args, **kwargs)
        self.links = []
