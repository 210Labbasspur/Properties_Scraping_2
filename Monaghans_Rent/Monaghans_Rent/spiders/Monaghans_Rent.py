...
class Monaghans_Rent(scrapy.Spider):
    name = 'Monaghans_Rent'
    url = "https://www.monaghansrealestate.com/propertiesJson?callback=angular.callbacks._0&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=rental"
    ...
    count = 1
    db = 'Monaghans'
    collection = 'Monaghans_Rent'
    bucket_prefix = f'D_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(Monaghans_Rent, self).__init__(*args, **kwargs)
        self.links = []
