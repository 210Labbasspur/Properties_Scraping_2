...
class Garvey_Sale(scrapy.Spider):
    name = "Garvey_Sale"

    url = "https://www.garveycompany.com.au/properties-for-sale"
    ...
    def __init__(self, *args, **kwargs):
        super(Garvey_Sale, self).__init__(*args, **kwargs)
        self.links = []
