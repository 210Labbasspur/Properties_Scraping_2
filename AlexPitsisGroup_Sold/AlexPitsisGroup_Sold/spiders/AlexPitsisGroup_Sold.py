...
class AlexPitsisGroup_Sold(scrapy.Spider):
    name = "AlexPitsisGroup_Sold"

    url = "https://alexpitsisgroup.com.au/sold/?paged={}"
    ...
    count = 1
    db = 'AlexPitsisGroup'
    collection = 'AlexPitsisGroup_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(AlexPitsisGroup_Sold, self).__init__(*args, **kwargs)
        self.links = []
