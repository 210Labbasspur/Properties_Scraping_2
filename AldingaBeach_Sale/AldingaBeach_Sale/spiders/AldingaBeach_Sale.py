...
class AldingaBeach_Sale(scrapy.Spider):
    name = "AldingaBeach_Sale"

    url = "https://www.aldingabeachres.com.au/buy"
    ...
    def __init__(self, *args, **kwargs):
        super(AldingaBeach_Sale, self).__init__(*args, **kwargs)
        self.links = []
