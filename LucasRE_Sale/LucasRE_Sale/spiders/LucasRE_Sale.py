...
class LucasRE_Sale(scrapy.Spider):
    name = "LucasRE_Sale"

    url = "https://www.lucasre.com.au/pages/real-estate/results?widgetKey=203169&context=listings&returnAs=markup&listing_category=Residential&listing_sale_method=sale&display_sale_method=BUY&pg=1"
    ...
    def __init__(self, *args, **kwargs):
        super(LucasRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
