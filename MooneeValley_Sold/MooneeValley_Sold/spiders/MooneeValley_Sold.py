...
class MooneeValley_Sold(scrapy.Spider):
    name = 'MooneeValley_Sold'
    url = "https://www.mooneevalley.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold"
    ...
    count = 1
    db = 'MooneeValley'
    collection = 'MooneeValley_Sold'
    bucket_prefix = f'D_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(MooneeValley_Sold, self).__init__(*args, **kwargs)
        self.links = []
