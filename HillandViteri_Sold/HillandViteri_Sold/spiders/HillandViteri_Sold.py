...
class HillandViteri_Sold(scrapy.Spider):
    name = "HillandViteri_Sold"
    url = 'https://www.hillandviteriproperty.com.au/wp-admin/admin-ajax.php'
    ...
    'atts[type]': 'Commercial,ResidentialSale,NewDevelopment',
    ...
    def __init__(self, *args, **kwargs):
        super(HillandViteri_Sold, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2699)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Hill and Viteri Property'
