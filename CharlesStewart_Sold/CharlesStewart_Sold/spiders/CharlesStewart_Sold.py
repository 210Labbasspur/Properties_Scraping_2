...
class CharlesStewart_Sold(scrapy.Spider):
    name = "CharlesStewart_Sold"

    url = "https://charlesstewart.com.au/residential/sold-properties"
    ...
    count = 1
    db = 'CharlesStewart'
    collection = 'CharlesStewart_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(CharlesStewart_Sold, self).__init__(*args, **kwargs)
        self.links = []
