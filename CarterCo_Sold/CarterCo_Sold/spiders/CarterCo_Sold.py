...
class CarterCo_Sold(scrapy.Spider):
    name = "CarterCo_Sold"

    url = "https://www.carterandcoagents.com.au/selling/recent-sales/"
    ...
    def __init__(self, *args, **kwargs):
        super(CarterCo_Sold, self).__init__(*args, **kwargs)
        self.links = []
