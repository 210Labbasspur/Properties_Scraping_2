...
class MaddisonEA_Rent(scrapy.Spider):
    name = "MaddisonEA_Rent"

    url = "https://www.maddisonestateagents.com.au/rent"
    ...
    def __init__(self, *args, **kwargs):
        super(MaddisonEA_Rent, self).__init__(*args, **kwargs)
        self.links = []
