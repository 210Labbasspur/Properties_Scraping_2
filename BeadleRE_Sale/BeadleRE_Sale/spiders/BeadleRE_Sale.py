...
class BeadleRE_Sale(scrapy.Spider):
    name = 'BeadleRE_Sale'
    prefix = 'https://www.beadlerealestate.com.au'
    url = 'https://www.beadlerealestate.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=residential'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(BeadleRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def Detail_parse(self, mini_data,full_data):
        ...
        if detail_page_url not in database_sale_matching_url:
            ...
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2689)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Beadle Real Estate'
            ...
            item['Field11'] = full_data.get('fields').get('d_sold').strip()
