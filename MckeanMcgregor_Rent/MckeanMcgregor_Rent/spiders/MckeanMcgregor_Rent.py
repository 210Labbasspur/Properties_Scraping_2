...
class MckeanMcgregor_Rent(scrapy.Spider):
    name = "MckeanMcgregor_Rent"

    url = "https://www.mckeanmcgregor.com.au/pages/real-estate/results?widgetKey=192730&context=listings&returnAs=markup&listing_category=Residential&listing_sale_method=lease&display_sale_method=RENT&pg=1"
    ...
    count = 1
    db = 'MckeanMcgregor'
    collection = 'MckeanMcgregor_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(MckeanMcgregor_Rent, self).__init__(*args, **kwargs)
        self.links = []
