...
class KayBurton_Sale(scrapy.Spider):
    name = "KayBurton_Sale"

    url = "https://www.kayburton.com.au/buy/properties-for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(KayBurton_Sale, self).__init__(*args, **kwargs)
        self.links = []
