...
class NevilleRichards_Sold(scrapy.Spider):
    name = 'NevilleRichards_Sold'
    prefix = 'https://www.nevillerichards.com.au'
    url = "https://www.nevillerichards.com.au/selling/recent-sales/"
    headers = {
    ...
    count = 1
    db = 'NevilleRichards'
    collection = 'NevilleRichards_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(NevilleRichards_Sold, self).__init__(*args, **kwargs)
        self.links = []
