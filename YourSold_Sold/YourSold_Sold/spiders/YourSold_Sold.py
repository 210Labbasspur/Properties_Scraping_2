...
class YourSold_Sold(scrapy.Spider):
    name = 'YourSold_Sold'
    url = 'https://www.yoursoldrealestate.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=96&sort=d_sold%20desc&web_stage=sold'
    ...
    def __init__(self, *args, **kwargs):
        super(YourSold_Sold, self).__init__(*args, **kwargs)
        self.links = []
