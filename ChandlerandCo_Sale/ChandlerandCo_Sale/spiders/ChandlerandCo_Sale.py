...
class ChandlerandCo_Sale(scrapy.Spider):
    name = "ChandlerandCo_Sale"

    url = "https://chandlerandco.com.au/search-results/?type=Buy&suburb=all&submit=Search&propertytype=&min=&max=&bedroom=&bathroom=&carspace="
    ...
    def __init__(self, *args, **kwargs):
        super(ChandlerandCo_Sale, self).__init__(*args, **kwargs)
        self.links = []
