...
class IntegrityRE_Sold(scrapy.Spider):
    name = 'IntegrityRE_Sold'
    prefix = 'https://www.integrityrealestate.com.au'
    url = 'https://www.integrityrealestate.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(IntegrityRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
