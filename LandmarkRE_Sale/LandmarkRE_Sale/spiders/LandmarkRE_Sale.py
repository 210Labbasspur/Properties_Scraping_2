...
class LandmarkRE_Sale(scrapy.Spider):
    name = "LandmarkRE_Sale"

    url = "https://www.landmarkmelbournecbd.com/buy"
    ...
    def __init__(self, *args, **kwargs):
        super(LandmarkRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
