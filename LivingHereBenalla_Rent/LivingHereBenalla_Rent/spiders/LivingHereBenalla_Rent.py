...
class LivingHereBenalla_Rent(scrapy.Spider):
    name = "LivingHereBenalla_Rent"
    ...
    collection = 'LivingHereBenalla_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(LivingHereBenalla_Rent, self).__init__(*args, **kwargs)
        self.links = []
