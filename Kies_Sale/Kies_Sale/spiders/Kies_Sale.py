...
class Kies_Sale(scrapy.Spider):
    name = "Kies_Sale"

    url = "https://www.kies.com.au/residential-for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(Kies_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def start_requests(self):
        ...
        yield scrapy.Request('https://www.kies.com.au/land-for-sale/', headers=self.headers, callback=self.parse)
        yield scrapy.Request('https://www.kies.com.au/rural-for-sale/', headers=self.headers, callback=self.parse)
