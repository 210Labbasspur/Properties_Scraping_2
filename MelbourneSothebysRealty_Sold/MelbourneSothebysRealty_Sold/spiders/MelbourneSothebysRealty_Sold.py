...
class MelbourneSothebysRealty_Sold(scrapy.Spider):
    name = "MelbourneSothebysRealty_Sold"

    url = "https://melbournesothebysrealty.com/sold-properties?max=999999999&orderby=datedesc&searchtype=9&page=1"
    ...
    collection = 'MelbourneSothebysRealty_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(MelbourneSothebysRealty_Sold, self).__init__(*args, **kwargs)
        self.links = []
