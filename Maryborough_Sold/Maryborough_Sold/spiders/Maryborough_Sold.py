...
class Maryborough_Sold(scrapy.Spider):
    name = "Maryborough_Sold"

    url = "https://www.maryboroughballaratrealestate.com.au/sell/our-sold-results/"
    prefix = "https://www.maryboroughballaratrealestate.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(Maryborough_Sold, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2536)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Maryborough Ballarat Real Estate'
            ...
            item['Field6'] = response.xpath("//*[contains(@class,'la-bed')]/parent::*[1]/text()[2]").get('').strip()
            item['Field7'] = response.xpath("//*[contains(@class,'la-bath')]/parent::*[1]/text()[2]").get('').strip()
            item['Field8'] = response.xpath("//*[contains(@class,'la-car')]/parent::*[1]/text()[2]").get('').strip()
            ...
            prop_images = response.xpath("//*[contains(@class,'img-orientation-landscape')]/@src").getall()
            images = []
            ...
            item['Field35'] = response.url.split('/')[-2]

            land_area = response.xpath("//*[contains(@class,'la-expand-arrows-alt')]/parent::*[1]/text()[2]").get('').strip()
            if land_area:
