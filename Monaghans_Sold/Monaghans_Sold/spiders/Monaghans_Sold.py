...
class Monaghans_Sold(scrapy.Spider):
    name = 'Monaghans_Sold'
    url = "https://www.monaghansrealestate.com/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold"
    ...
    count = 1
    db = 'Monaghans'
    collection = 'Monaghans_Sold'
    bucket_prefix = f'D_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(Monaghans_Sold, self).__init__(*args, **kwargs)
        self.links = []
