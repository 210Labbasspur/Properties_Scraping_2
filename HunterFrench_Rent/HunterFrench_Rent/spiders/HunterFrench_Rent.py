...
class HunterFrench_Rent(scrapy.Spider):
    name = "HunterFrench_Rent"

    url = "https://www.hunterfrench.com.au/for-lease/"
    ...
    def __init__(self, *args, **kwargs):
        super(HunterFrench_Rent, self).__init__(*args, **kwargs)
        self.links = []
