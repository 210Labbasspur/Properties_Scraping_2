...
class TheCoastRE_Rent(scrapy.Spider):
    name = "TheCoastRE_Rent"
    url = "https://thecoast.com.au/listings?saleOrRental=Rental&status=available_under_contract&sortby=post_date-desc"
    prefix = "https://thecoast.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(TheCoastRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def parse(self, response):
        ...
        for each_url in all_links:
            each_url = f'https://thecoast.com.au{each_url}'
        ...
        for property_url in all_links:
            property_url = f'https://thecoast.com.au{property_url}'
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2804)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'The Coast Real Estate'
