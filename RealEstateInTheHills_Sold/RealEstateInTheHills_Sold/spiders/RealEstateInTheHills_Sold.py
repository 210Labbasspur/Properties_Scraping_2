...
class RealEstateInTheHills_Sold(scrapy.Spider):
    name = "RealEstateInTheHills_Sold"

    url = "https://realestateinthehills.com/recent-sales/"
    ...
    collection = 'RealEstateInTheHills_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(RealEstateInTheHills_Sold, self).__init__(*args, **kwargs)
        self.links = []
