...
class StateWide_Sale(scrapy.Spider):
    name = "StateWide_Sale"

    url = "https://www.statewideproperty.net/buy/residential-for-sale"
    ...
    def __init__(self, *args, **kwargs):
        super(StateWide_Sale, self).__init__(*args, **kwargs)
        self.links = []
