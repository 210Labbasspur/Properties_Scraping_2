...
class CarterCo_Rent(scrapy.Spider):
    name = "CarterCo_Rent"

    url = "https://www.carterandcoagents.com.au/renting/properties-for-lease/"
    prefix = "https://www.carterandcoagents.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(CarterCo_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2410)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Carter + Co'
