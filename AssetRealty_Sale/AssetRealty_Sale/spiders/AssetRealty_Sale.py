...
class AssetRealty_Sale(scrapy.Spider):
    name = "AssetRealty_Sale"

    url = "https://www.assetrealty.com.au/buy/residential/"
    ...
    def __init__(self, *args, **kwargs):
        super(AssetRealty_Sale, self).__init__(*args, **kwargs)
        self.links = []
