...
class GavinButler_Sale(scrapy.Spider):
    name = 'GavinButler_Sale'
    url = 'https://www.gavinbutler.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=96&sort=d_listing%20desc&listing_cat=residential'
    ...
    def __init__(self, *args, **kwargs):
        super(GavinButler_Sale, self).__init__(*args, **kwargs)
        self.links = []
