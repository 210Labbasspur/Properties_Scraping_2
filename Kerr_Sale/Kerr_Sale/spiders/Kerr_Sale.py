...
class Kerr_Sale(scrapy.Spider):
    name = 'Kerr_Sale'
    prefix = 'https://www.kerrrealestate.com.au'
    url = "https://www.kerrrealestate.com.au/buying/properties-for-sale/"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(Kerr_Sale, self).__init__(*args, **kwargs)
        self.links = []
