...
class LeytonRE_Sold(scrapy.Spider):
    name = "LeytonRE_Sold"
    url = 'https://www.leytonre.com.au/wp-admin/admin-ajax.php'
    prefix = "https://www.leytonre.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(LeytonRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2789)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Leyton Real Estate'
