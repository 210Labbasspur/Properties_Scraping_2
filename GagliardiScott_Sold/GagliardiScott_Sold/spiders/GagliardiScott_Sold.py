...
class GagliardiScott_Sold(scrapy.Spider):
    name = "GagliardiScott_Sold"

    url = "https://www.gagliardiscott.com.au/search/?show_in_sale=true&sold=1"
    ...
    count = 1
    db = 'GagliardiScott'
    collection = 'GagliardiScott_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(GagliardiScott_Sold, self).__init__(*args, **kwargs)
        self.links = []
