...
class CaseyEstateAgents_Sale(scrapy.Spider):
    name = "CaseyEstateAgents_Sale"

    url = "https://www.caseyestateagents.melbourne/pages/real-estate/results?widgetKey=283015&context=listings&returnAs=markup&listing_sale_method=Sale&pg=1"
    ...
    collection = 'CaseyEstateAgents_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(CaseyEstateAgents_Sale, self).__init__(*args, **kwargs)
        self.links = []
