...
class LuxeAgents_Sold(scrapy.Spider):
    name = "LuxeAgents_Sold"

    url = "https://www.luxeagents.com.au/data/results/?listing_sale_method=Sale&listing_status=sold&status=sold&pg={}"
    ...
    def __init__(self, *args, **kwargs):
        super(LuxeAgents_Sold, self).__init__(*args, **kwargs)
        self.links = []
