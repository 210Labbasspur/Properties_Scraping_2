...
class BorisProperty_Sale(scrapy.Spider):
    name = 'BorisProperty_Sale'
    url = "https://www.borisproperty.com.au/for-sale/listed-properties/"
    ...
    count = 1
    db = 'BorisProperty'
    collection = 'BorisProperty_Sale'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(BorisProperty_Sale, self).__init__(*args, **kwargs)
        self.links = []
