...
class NickTang_Sold(scrapy.Spider):
    name = "NickTang_Sold"

    url = "https://www.nicktangproperty.com.au/properties/sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(NickTang_Sold, self).__init__(*args, **kwargs)
        self.links = []
