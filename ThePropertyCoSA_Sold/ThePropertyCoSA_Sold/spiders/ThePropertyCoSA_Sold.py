...
class ThePropertyCoSA_Sold(scrapy.Spider):
    name = "ThePropertyCoSA_Sold"
    ...
    count = 1
    db = 'ThePropertyCoSA'
    collection = 'ThePropertyCoSA_Sold'
    bucket_prefix = f'Images6'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(ThePropertyCoSA_Sold, self).__init__(*args, **kwargs)
        self.links = []
