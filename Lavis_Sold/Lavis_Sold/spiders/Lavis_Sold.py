...
class Lavis_Sold(scrapy.Spider):
    name = 'Lavis_Sold'
    url = 'https://www.lavisrealestate.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold'
    ...
    def __init__(self, *args, **kwargs):
        super(Lavis_Sold, self).__init__(*args, **kwargs)
        self.links = []
