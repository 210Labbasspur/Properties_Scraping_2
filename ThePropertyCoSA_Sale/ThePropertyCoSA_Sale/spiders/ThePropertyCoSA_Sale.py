...
class ThePropertyCoSA_Sale(scrapy.Spider):
    name = "ThePropertyCoSA_Sale"
    ...
    count = 1
    db = 'ThePropertyCoSA'
    collection = 'ThePropertyCoSA_Sale'
    bucket_prefix = f'Images6'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(ThePropertyCoSA_Sale, self).__init__(*args, **kwargs)
        self.links = []
