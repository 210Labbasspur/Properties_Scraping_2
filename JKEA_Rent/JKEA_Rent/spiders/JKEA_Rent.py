...
class JKEA_Rent(scrapy.Spider):
    name = "JKEA_Rent"

    url = 'https://www.jkea.com.au/search/?show_in_rental=true&show_in_residential=true&sold=0'
    ...
    def __init__(self, *args, **kwargs):
        super(JKEA_Rent, self).__init__(*args, **kwargs)
        self.links = []
