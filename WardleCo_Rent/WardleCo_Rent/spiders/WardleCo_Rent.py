...
class WardleCo_Rent(scrapy.Spider):
    name = 'WardleCo_Rent'
    url = 'https://www.wardlecorealestate.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=rental'
    ...
    def __init__(self, *args, **kwargs):
        super(WardleCo_Rent, self).__init__(*args, **kwargs)
        self.links = []
