...
class MandyLee_Sold(scrapy.Spider):
    name = 'MandyLee_Sold'
    prefix = 'https://www.mandylee.com.au'
    url = "https://www.mandylee.com.au/selling/recent-sales/"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(MandyLee_Sold, self).__init__(*args, **kwargs)
        self.links = []
