...
class Toop_Rent(scrapy.Spider):
    ...
    data = '{"requests":[{"indexName":"prod_LISTINGS","params":"query=&page=0&hitsPerPage=1000&filters=bedrooms%20%3E%3D%200%20AND%20bathrooms%20%3E%3D%200%20AND%20carports%20%3E%3D%200%20AND%20price%3A%200%20TO%204000%20AND%20(listingCategory%3Arental)%20AND%20(availability%3AAvailable)&aroundLatLng=&aroundRadius=5000"}]}'
