...
class MandyLee_Sale(scrapy.Spider):
    name = 'MandyLee_Sale'
    prefix = 'https://www.mandylee.com.au'
    url = "https://www.mandylee.com.au/buying/residential-sales/"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(MandyLee_Sale, self).__init__(*args, **kwargs)
        self.links = []
