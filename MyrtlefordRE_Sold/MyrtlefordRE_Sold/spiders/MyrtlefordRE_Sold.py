...
class MyrtlefordRE_Sold(scrapy.Spider):
    name = "MyrtlefordRE_Sold"

    url = "https://www.myrtlefordrel.com.au/sell/recent-sales/"
    ...
    def __init__(self, *args, **kwargs):
        super(MyrtlefordRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
