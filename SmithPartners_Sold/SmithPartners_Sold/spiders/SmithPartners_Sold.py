...
class SmithPartners_Sold(scrapy.Spider):
    name = "SmithPartners_Sold"
    url = "https://smithpartnersrealestate.com.au/listings?saleOrRental=Sale&status=sold&sortby=saleDate-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(SmithPartners_Sold, self).__init__(*args, **kwargs)
        self.links = []
