...
class StrzeleckiRealty_Rent(scrapy.Spider):
    name = 'StrzeleckiRealty_Rent'
    url = 'https://www.strzeleckirealty.com.au/propertiesJson?callback=angular.callbacks._0&currentPage={}&perPage=96&sort=d_listing%20desc&listing_cat=rental'
    ...
    count = 1
    db = 'StrzeleckiRealty'
    collection = 'StrzeleckiRealty_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(StrzeleckiRealty_Rent, self).__init__(*args, **kwargs)
        self.links = []
