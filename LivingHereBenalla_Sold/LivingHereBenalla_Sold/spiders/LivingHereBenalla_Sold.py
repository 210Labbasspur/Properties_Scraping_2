...
class LivingHereBenalla_Sold(scrapy.Spider):
    name = "LivingHereBenalla_Sold"
    ...
    collection = 'LivingHereBenalla_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(LivingHereBenalla_Sold, self).__init__(*args, **kwargs)
        self.links = []
