...
class VoglWalpole_Sale(scrapy.Spider):
    name = "VoglWalpole_Sale"

    url = "https://www.voglwalpole.com.au/buy/"
    ...
    def __init__(self, *args, **kwargs):
        super(VoglWalpole_Sale, self).__init__(*args, **kwargs)
        self.links = []
