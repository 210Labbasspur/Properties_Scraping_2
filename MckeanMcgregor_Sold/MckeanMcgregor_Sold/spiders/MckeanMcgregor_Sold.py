...
class MckeanMcgregor_Sold(scrapy.Spider):
    name = "MckeanMcgregor_Sold"

    url = "https://www.mckeanmcgregor.com.au/pages/real-estate/results?widgetKey=192730&context=listings&returnAs=markup&listing_category=Residential&listing_sale_method=sale&display_sale_method=SOLD&status=sold&pg=1"
    ...
    count = 1
    db = 'MckeanMcgregor'
    collection = 'MckeanMcgregor_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(MckeanMcgregor_Sold, self).__init__(*args, **kwargs)
        self.links = []
