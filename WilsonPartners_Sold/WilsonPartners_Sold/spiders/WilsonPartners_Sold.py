...
class WilsonPartners_Sold(scrapy.Spider):
    name = "WilsonPartners_Sold"

    url = "https://www.wilsonpartners.com.au/selling/recently-sold/"
    ...
    count = 1
    db = 'WilsonPartners'
    collection = 'WilsonPartners_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(WilsonPartners_Sold, self).__init__(*args, **kwargs)
        self.links = []
