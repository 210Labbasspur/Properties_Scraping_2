...
class OUSProperty_Rent(scrapy.Spider):
    name = "OUSProperty_Rent"
    url = 'https://www.ous.property/wp-admin/admin-ajax.php'
    prefix = "https://www.ous.property"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(OUSProperty_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2458)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'OUS Property'
