...
class LandmarkRE_Sold(scrapy.Spider):
    name = "LandmarkRE_Sold"

    url = "https://www.landmarkmelbournecbd.com/recently-sold"
    prefix = "https://www.landmarkmelbournecbd.com"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(LandmarkRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def parse(self, response):
        ...
        for each_url in all_links:
            each_url = f'https://www.landmarkmelbournecbd.com{each_url}'
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2381)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Landmark Real Estate'
            ...
            item['Field6'] = response.xpath("//*[contains(@class,'lt-icon flaticon-person1 big')]/parent::*[1]/text()").get('').strip()
            item['Field7'] = response.xpath("//*[contains(@class,'lt-icon flaticon-shower5')]/parent::*[1]/text()").get('').strip()
            item['Field8'] = response.xpath("//*[contains(@class,'lt-icon flaticon-car95')]/parent::*[1]/text()").get('').strip()
