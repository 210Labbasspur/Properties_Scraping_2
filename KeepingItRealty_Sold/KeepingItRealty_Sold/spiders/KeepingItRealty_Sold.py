...
class KeepingItRealty_Sold(scrapy.Spider):
    name = "KeepingItRealty_Sold"

    url = "https://www.keepingitrealty.com.au/sold-properties/"
    ...
    count = 1
    db = 'KeepingItRealty'
    collection = 'KeepingItRealty_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(KeepingItRealty_Sold, self).__init__(*args, **kwargs)
        self.links = []
