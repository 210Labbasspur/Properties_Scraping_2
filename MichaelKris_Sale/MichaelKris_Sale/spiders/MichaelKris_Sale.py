...
class MichaelKris_Sale(scrapy.Spider):
    name = "MichaelKris_Sale"

    url = "https://www.michaelkris.com.au/buying/properties-for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(MichaelKris_Sale, self).__init__(*args, **kwargs)
        self.links = []
