...
class OCRE_Sale(scrapy.Spider):
    name = "OCRE_Sale"

    url = "https://ocre.com.au/property/?action=epl_search&post_type=property&property_status=current"
    ...
    def __init__(self, *args, **kwargs):
        super(OCRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
