...
class Rendina_Rent(scrapy.Spider):
    name = "Rendina_Rent"

    url = "https://www.rendina.com.au/pages/real-estate/results?listing_sale_method=rent&listing_category=residential"
    ...
    def __init__(self, *args, **kwargs):
        super(Rendina_Rent, self).__init__(*args, **kwargs)
        self.links = []
