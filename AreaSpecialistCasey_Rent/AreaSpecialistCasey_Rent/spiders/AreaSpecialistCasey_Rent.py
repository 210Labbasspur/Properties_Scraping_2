...
class AreaSpecialistCasey_Rent(scrapy.Spider):
    name = "AreaSpecialistCasey_Rent"

    url = "https://www.areaspecialistcasey.com.au/pages/real-estate/results?widgetKey=122479&context=listings&returnAs=markup&listing_sale_method=lease&display_sale_method=RENT&pg=1"
    ...
    collection = 'AreaSpecialistCasey_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(AreaSpecialistCasey_Rent, self).__init__(*args, **kwargs)
        self.links = []
