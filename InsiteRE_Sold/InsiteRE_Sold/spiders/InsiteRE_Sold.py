...
class InsiteRE_Sold(scrapy.Spider):
    name = "InsiteRE_Sold"
    url = "https://insiterealestate.com.au/listings?page=1&saleOrRental=Sale&rental_period=week&status=sold&viewType=gallery"
    ...
    def __init__(self, *args, **kwargs):
        super(InsiteRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
