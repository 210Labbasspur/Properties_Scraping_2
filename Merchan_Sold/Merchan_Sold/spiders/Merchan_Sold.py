...
class Merchan_Sold(scrapy.Spider):
    name = "Merchan_Sold"
    url = ('https://merchan.com.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bcount%5D%5Bvalue%5D=20&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Bmeta_key%5D%5Bvalue%5D=saleDate&query%5Bsold%5D%5Bvalue%5D=1&query%5Bsold%5D%5Btype%5D=equal&query%5BsaleOrRental%5D%5Bvalue%5D=Sale&query%5BsaleOrRental%5D%5Btype%5D=equal&query%5Bextended%5D%5Bvalue%5D=0&query'
    ...
    count = 1
    db = 'Merchan'
    collection = 'Merchan_Sold'
    bucket_prefix = f'Images6'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(Merchan_Sold, self).__init__(*args, **kwargs)
        self.links = []
