...
class DannyEdebohls_Sale(scrapy.Spider):
    name = "DannyEdebohls_Sale"
    url = 'https://www.dannyedebohlspropertysales.com.au/wp-json/api/listings/all?priceRange=&category=&buildingArea=&type=property&status=current&paged={}&limit=23&bed=&bath=&car=&sort='
    ...
    def __init__(self, *args, **kwargs):
        super(DannyEdebohls_Sale, self).__init__(*args, **kwargs)
        self.links = []
