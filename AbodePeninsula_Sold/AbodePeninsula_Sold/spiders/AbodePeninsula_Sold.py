...
class AbodePeninsula_Sold(scrapy.Spider):
    name = "AbodePeninsula_Sold"

    url = "https://www.abodepeninsula.com.au/sold-properties"
    ...
    count = 1
    db = 'AbodePeninsula'
    collection = 'AbodePeninsula_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(AbodePeninsula_Sold, self).__init__(*args, **kwargs)
        self.links = []
