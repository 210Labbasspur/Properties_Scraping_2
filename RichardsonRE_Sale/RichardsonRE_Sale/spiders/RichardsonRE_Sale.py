...
class RichardsonRE_Sale(scrapy.Spider):
    name = "RichardsonRE_Sale"

    url = "https://hfrcolac.com.au/buy"
    ...
    def __init__(self, *args, **kwargs):
        super(RichardsonRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
