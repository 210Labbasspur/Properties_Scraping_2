...
class LucasRE_Sold(scrapy.Spider):
    name = "LucasRE_Sold"

    url = "https://www.lucasre.com.au/pages/real-estate/results?widgetKey=203169&context=listings&returnAs=markup&listing_sale_method=sale&display_sale_method=SOLD&status=sold&pg=1"
    ...
    def __init__(self, *args, **kwargs):
        super(LucasRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
