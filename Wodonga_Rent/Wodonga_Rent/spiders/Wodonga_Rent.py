...
class Wodonga_Rent(scrapy.Spider):
    name = "Wodonga_Rent"

    url = "https://www.wodongarealestate.com.au/renting/properties-for-lease/"
    ...
    def __init__(self, *args, **kwargs):
        super(Wodonga_Rent, self).__init__(*args, **kwargs)
        self.links = []
