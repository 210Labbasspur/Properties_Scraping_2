...
class GagliardiScott_Rent(scrapy.Spider):
    name = "GagliardiScott_Rent"

    url = "https://www.gagliardiscott.com.au/search/?show_in_rental=true&sold=0&show_in_residential=true"
    ...
    count = 1
    db = 'GagliardiScott'
    collection = 'GagliardiScott_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(GagliardiScott_Rent, self).__init__(*args, **kwargs)
        self.links = []
