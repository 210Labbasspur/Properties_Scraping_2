...
class CampbellPotts_Rent(scrapy.Spider):
    name = "CampbellPotts_Rent"

    url = "http://campbellpotts.com.au/properties-for-rent"
    ...
    def __init__(self, *args, **kwargs):
        super(CampbellPotts_Rent, self).__init__(*args, **kwargs)
        self.links = []
