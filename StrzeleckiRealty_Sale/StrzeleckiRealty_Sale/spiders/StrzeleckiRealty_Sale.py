...
class StrzeleckiRealty_Sale(scrapy.Spider):
    name = 'StrzeleckiRealty_Sale'
    url = 'https://www.strzeleckirealty.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=96&sort=d_listing%20desc&listing_cat=residential'
    prefix = 'https://www.strzeleckirealty.com.au'
    headers = {
        'accept': '*/*',
    ...
    count = 1
    db = 'StrzeleckiRealty'
    collection = 'StrzeleckiRealty_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(StrzeleckiRealty_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def Detail_parse(self, mini_data,full_data):
        ...
        if detail_page_url not in database_sale_matching_url:
            ...
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2715)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Strzelecki Realty'
