...
class CEPG_Rent(scrapy.Spider):
    name = "CEPG_Rent"
    url = "https://cepg.com.au/listings/?page=1&saleOrRental=Rental&rental_period=week&type=residential&viewType=gallery&sortby=dateListed-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(CEPG_Rent, self).__init__(*args, **kwargs)
        self.links = []
