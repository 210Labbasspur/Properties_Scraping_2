...
class GarryNash_Sold(scrapy.Spider):
    name = "GarryNash_Sold"

    url = "https://www.garrynash.com.au/pages/real-estate/results?widgetKey=158597&context=listings&returnAs=markup&listing_category=residential&listing_sale_method=sale&status=sold&pg=1"
    prefix = "https://www.garrynash.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(GarryNash_Sold, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def parse(self, response):
        ...
        for each_url in all_links:
            each_url = f'https://www.garrynash.com.au{each_url}'
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2618)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Garry Nash & Co Real Estate'
