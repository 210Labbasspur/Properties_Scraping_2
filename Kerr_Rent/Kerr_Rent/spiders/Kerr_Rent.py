...
class Kerr_Rent(scrapy.Spider):
    name = 'Kerr_Rent'
    prefix = 'https://www.kerrrealestate.com.au'
    url = "https://www.kerrrealestate.com.au/renting/properties-for-lease/"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(Kerr_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2683)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Kerr Real Estate'
