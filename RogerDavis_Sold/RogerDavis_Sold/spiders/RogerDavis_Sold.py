...
class RogerDavis_Sold(scrapy.Spider):
    name = "RogerDavis_Sold"

    url = "https://www.rogerdavis.com.au/selling/recent-sales/"
    ...
    def __init__(self, *args, **kwargs):
        super(RogerDavis_Sold, self).__init__(*args, **kwargs)
        self.links = []
