...
class WilsonsWarrnambool_Rent(scrapy.Spider):
    name = "WilsonsWarrnambool_Rent"

    url = "https://wilsonswarrnambool.com.au/properties-for-rent/"
    ...
    collection = 'WilsonsWarrnambool_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(WilsonsWarrnambool_Rent, self).__init__(*args, **kwargs)
        self.links = []
