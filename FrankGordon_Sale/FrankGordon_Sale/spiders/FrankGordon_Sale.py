...
class FrankGordon_Sale(scrapy.Spider):
    name = "FrankGordon_Sale"

    url = "https://www.frankgordon.com.au/for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(FrankGordon_Sale, self).__init__(*args, **kwargs)
        self.links = []
