...
class TimMorrisRE_Rent(scrapy.Spider):
    name = 'TimMorrisRE_Rent'
    url = "https://www.timmorris.com.au/rent/properties-for-lease/"
    ...
    count = 1
    db = 'TimMorrisRE'
    collection = 'TimMorrisRE_Rent'
    # bucket_prefix = f'D_{collection}'
    bucket_prefix = f'Images10'
    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(TimMorrisRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
