...
class Mirvac_Rent(scrapy.Spider):
    name = "Mirvac_Rent"
    url = 'https://www.resbymirvac.com/wp-admin/admin-ajax.php'
    prefix = "https://www.resbymirvac.com"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(Mirvac_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2553)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Real Estate Services by Mirvac'
