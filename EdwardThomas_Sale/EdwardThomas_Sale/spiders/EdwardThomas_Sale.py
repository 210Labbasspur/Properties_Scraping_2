...
class EdwardThomas_Sale(scrapy.Spider):
    name = "EdwardThomas_Sale"
    url = "https://edwardthomas.com.au/listings?page=1&saleOrRental=Sale&rental_period=week&status=available_under_contract&viewType=gallery&sortby=dateListed-desc"
    prefix = "https://edwardthomas.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(EdwardThomas_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def parse(self, response):
        ...
        for each_url in all_links:
            each_url = f'https://edwardthomas.com.au{each_url}'
        ...
        for property_url in all_links:
            property_url = f'https://edwardthomas.com.au{property_url}'
