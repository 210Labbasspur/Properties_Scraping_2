...
class RogerDavis_Sale(scrapy.Spider):
    name = "RogerDavis_Sale"

    url = "https://www.rogerdavis.com.au/buying/properties-for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(RogerDavis_Sale, self).__init__(*args, **kwargs)
        self.links = []
