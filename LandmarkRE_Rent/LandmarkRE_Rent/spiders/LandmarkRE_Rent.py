...
class LandmarkRE_Rent(scrapy.Spider):
    name = "LandmarkRE_Rent"

    url = "https://www.landmarkmelbournecbd.com/rent"
    ...
    def __init__(self, *args, **kwargs):
        super(LandmarkRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
