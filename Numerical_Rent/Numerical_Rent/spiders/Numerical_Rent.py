...
class Numerical_Rent(scrapy.Spider):
    name = "Numerical_Rent"
    url = "https://numericalrealestate.com/listings/?saleOrRental=Rental&type=Residential&order=dateListed-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(Numerical_Rent, self).__init__(*args, **kwargs)
        self.links = []
