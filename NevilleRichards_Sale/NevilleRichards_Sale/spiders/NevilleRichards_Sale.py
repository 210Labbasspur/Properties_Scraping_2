...
class NevilleRichards_Sale(scrapy.Spider):
    name = 'NevilleRichards_Sale'
    prefix = 'https://www.nevillerichards.com.au'
    url = "https://www.nevillerichards.com.au/buying/properties-for-sale/"
    headers = {
    ...
    count = 1
    db = 'NevilleRichards'
    collection = 'NevilleRichards_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(NevilleRichards_Sale, self).__init__(*args, **kwargs)
        self.links = []
