...
class NickTang_Rent(scrapy.Spider):
    name = "NickTang_Rent"

    url = "https://www.nicktangproperty.com.au/properties/rental/"
    prefix = "https://www.nicktangproperty.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(NickTang_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2645)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Nick Tang Property'
            ...
            prop_images = response.xpath("//*[contains(@data-fancybox,'slider-gallery')]/@href").getall()
            images = []
            ...
            feature_count = 58
            for feature in response.css(".feature"):   ##  first 4 features are ID, bed, bath etc.
